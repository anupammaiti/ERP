...
CREATE TABLE `hostel_details` (
  ...
  `hostelid` varchar(10) DEFAULT NULL,
  `hostelname` varchar(100) DEFAULT NULL,
  `catagiry` varchar(5) DEFAULT NULL,
...
--
-- Table structure for table `hst_features`
--

DROP TABLE IF EXISTS `hst_features`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `hst_features` (
  `hstid` varchar(30) NOT NULL,
  ...
  `f6` varchar(30) DEFAULT NULL,
  `f7` varchar(30) DEFAULT NULL,
  `f8` varchar(30) DEFAULT NULL,
  `f9` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `hst_features`
--

LOCK TABLES `hst_features` WRITE;
/*!40000 ALTER TABLE `hst_features` DISABLE KEYS */;
/*!40000 ALTER TABLE `hst_features` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tl_chit_allottosub`
--

DROP TABLE IF EXISTS `tl_chit_allottosub`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tl_chit_allottosub` (
  `sno` bigint(20) NOT NULL AUTO_INCREMENT,
  `subid` varchar(255) DEFAULT NULL,
  `name` varchar(255) DEFAULT NULL,
  `groupid` varchar(255) DEFAULT NULL,
  `amount` varchar(255) DEFAULT NULL,
  `dateofpay` varchar(255) DEFAULT NULL,
  `ipm` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `tl_chit_allottosub`
--

LOCK TABLES `tl_chit_allottosub` WRITE;
/*!40000 ALTER TABLE `tl_chit_allottosub` DISABLE KEYS */;
INSERT INTO `tl_chit_allottosub` VALUES (1,'sub01','KrishnakishorePunnavargula','5LY','50000','2015-07-04','50000','30',NULL),(2,'sub01','KrishnakishorePunnavargula','5LY','50000','2015-07-04','50000','30',NULL),(3,'sub_4','RaviKiranRayaprolu','10LY','100000','2015-07-17','0','10',NULL),(4,'sub_2','nullPunnavargula','5LY','500000','2015-06-01','20000','20',NULL),(5,'sub5','Lakshmikurapati','5LY','500000','2015-06-01','20000','20',NULL);
/*!40000 ALTER TABLE `tl_chit_allottosub` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tl_chit_group`
--

DROP TABLE IF EXISTS `tl_chit_group`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tl_chit_group` (
  `sno` bigint(20) NOT NULL AUTO_INCREMENT,
  `groupname` varchar(255) DEFAULT NULL,
  `desription` varchar(255) DEFAULT NULL,
  `gendate` varchar(255) DEFAULT NULL,
  `noofpeople` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`sno`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tl_chit_group`
--

LOCK TABLES `tl_chit_group` WRITE;
/*!40000 ALTER TABLE `tl_chit_group` DISABLE KEYS */;
INSERT INTO `tl_chit_group` VALUES (1,'5LY','5lacks','2015-07-01','25'),(3,'10LY','10Lacks',NULL,'30'),(4,'YL5','5Lacks','2015-08-08','20');
/*!40000 ALTER TABLE `tl_chit_group` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tl_chit_payment`
--

DROP TABLE IF EXISTS `tl_chit_payment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tl_chit_payment` (
  `sno` bigint(20) NOT NULL AUTO_INCREMENT,
  `subid` varchar(255) DEFAULT NULL,
  `groupid` varchar(255) DEFAULT NULL,
  `divident` varchar(255) DEFAULT NULL,
  `amount` varchar(255) DEFAULT NULL,
  `payingmonth` varchar(255) DEFAULT NULL,
  `dateofpayment` varchar(255) DEFAULT NULL,
  `prizebidderdate` varchar(255) DEFAULT NULL,
  `prizebiddingamount` varchar(255) DEFAULT NULL,
  `status` varchar(255) DEFAULT NULL,
  `monthlypayment` varchar(255) DEFAULT NULL,
  `amountpaid` varchar(255) DEFAULT NULL,
  `remainingamount` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`sno`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tl_chit_payment`
--

LOCK TABLES `tl_chit_payment` WRITE;
/*!40000 ALTER TABLE `tl_chit_payment` DISABLE KEYS */;
INSERT INTO `tl_chit_payment` VALUES (1,'sub01','5LY','2000',NULL,'402000','2015-07-09','yyyy-mm-dd','','PrizedBidder',NULL,NULL,NULL),(2,'sub01','5LY','',NULL,'','yyyy-mm-dd',NULL,NULL,'Paid',NULL,NULL,NULL),(3,'sub_4','10LY','0',NULL,'1','2015-07-17',NULL,NULL,'Paid',NULL,NULL,NULL);
/*!40000 ALTER TABLE `tl_chit_payment` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tl_chit_prizedbidder`
--

DROP TABLE IF EXISTS `tl_chit_prizedbidder`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tl_chit_prizedbidder` (
  `sno` bigint(20) NOT NULL AUTO_INCREMENT,
  `subid` varchar(255) DEFAULT NULL,
  `name` varchar(255) DEFAULT NULL,
  `groupid` varchar(255) DEFAULT NULL,
  ...
  `noofpeople` varchar(255) DEFAULT NULL,
  `status` varchar(255) DEFAULT NULL,
  `dividentperhead` varchar(255) DEFAULT NULL,
  `amountget` varchar(255) DEFAULT NULL,
  `fixedamount` varchar(255) DEFAULT NULL,
  `fixeddivident` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`sno`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tl_chit_prizedbidder`
--

LOCK TABLES `tl_chit_prizedbidder` WRITE;
/*!40000 ALTER TABLE `tl_chit_prizedbidder` DISABLE KEYS */;
INSERT INTO `tl_chit_prizedbidder` VALUES (1,'sub01','Krishnakishore Punnavargula','5LY','2015-07-15','500000','2000',NULL,'24900','20',NULL,NULL,NULL,NULL,NULL),(2,'sub01','Krishnakishore Punnavargula','5LY','2015-07-15','500000','2000',NULL,'498100','20','PrizedBidder','100','498000',NULL,NULL),(3,'sub01','Krishnakishore Punnavargula','5LY','yyyy-mm-dd','','',NULL,'','','PrizedBidder','','',NULL,NULL);
/*!40000 ALTER TABLE `tl_chit_prizedbidder` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tl_chit_subscriber`
--

DROP TABLE IF EXISTS `tl_chit_subscriber`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tl_chit_subscriber` (
  `sno` bigint(20) NOT NULL AUTO_INCREMENT,
  ...
  `subsriberid` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`sno`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tl_chit_subscriber`
--

LOCK TABLES `tl_chit_subscriber` WRITE;
/*!40000 ALTER TABLE `tl_chit_subscriber` DISABLE KEYS */;
INSERT INTO `tl_chit_subscriber` VALUES (1,'KrishnaKamalakar','Rayaprolu','9963514955','kishore.msc@gmail.com','Hyderabad.','040-2345678','sub01'),(2,NULL,'Punnavargula','9963514955','kishore.msc@gmail.com','Near Pjr Statue','040-2345678','sub_2'),(3,NULL,'Punnavargula','9963514955','kishore.msc@gmail.com','Near Pjr Statue\r\n','040-2345678','sub_3'),(4,'RaviKiran','Rayaprolu','7702305661','rayaprolu.ravikiran@gmail.com','Repalle.','08648223874','sub_4'),(5,'Lakshmi','kurapati','923053421222','lakshmi.kurapati@gmail.com','Hyderabad','08648223874','sub5');
/*!40000 ALTER TABLE `tl_chit_subscriber` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tl_companypayslip`
--

DROP TABLE IF EXISTS `tl_companypayslip`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tl_companypayslip` (
  `sno` bigint(20) NOT NULL AUTO_INCREMENT,
  ...
  `tx7` varchar(255) DEFAULT NULL,
  `tx8` varchar(255) DEFAULT NULL,
  `tx9` varchar(255) DEFAULT NULL,
  `tx10` varchar(255) DEFAULT NULL,
  `tx11` varchar(255) DEFAULT NULL,
  `tx12` varchar(255) DEFAULT NULL,
  `ftx1` varchar(255) DEFAULT NULL,
  `ftx2` varchar(255) DEFAULT NULL,
  `ftx3` varchar(255) DEFAULT NULL,
  `ftx4` varchar(255) DEFAULT NULL,
  `ftx5` varchar(255) DEFAULT NULL,
  `ftx6` varchar(255) DEFAULT NULL,
  `ftx7` varchar(255) DEFAULT NULL,
  `ftx8` varchar(255) DEFAULT NULL,
  `ftx9` varchar(255) DEFAULT NULL,
  `ftx10` varchar(255) DEFAULT NULL,
  `ftx11` varchar(255) DEFAULT NULL,
  `ftx12` varchar(255) DEFAULT NULL,
  `gendate` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`sno`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `tl_companypayslip`
--

LOCK TABLES `tl_companypayslip` WRITE;
/*!40000 ALTER TABLE `tl_companypayslip` DISABLE KEYS */;
/*!40000 ALTER TABLE `tl_companypayslip` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tl_courierDispath`
--

DROP TABLE IF EXISTS `tl_courierDispath`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tl_courierDispath` (
  `sno` bigint(20) NOT NULL AUTO_INCREMENT,
  `dispatchdocument` varchar(255) DEFAULT NULL,
  `prospectus` varchar(255) DEFAULT NULL,
  `noteligible` varchar(255) DEFAULT NULL,
  `mislenious` varchar(255) DEFAULT NULL,
  `paymentmode` varchar(255) DEFAULT NULL,
  `displatchmode` varchar(255) DEFAULT NULL,
  `byhand` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `tl_courierDispath`
--

LOCK TABLES `tl_courierDispath` WRITE;
/*!40000 ALTER TABLE `tl_courierDispath` DISABLE KEYS */;
/*!40000 ALTER TABLE `tl_courierDispath` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tl_courierReciept`
--

DROP TABLE IF EXISTS `tl_courierReciept`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tl_courierReciept` (
  `sno` bigint(20) NOT NULL AUTO_INCREMENT,
  `recieptdate` varchar(255) DEFAULT NULL,
  `formdtype` varchar(255) DEFAULT NULL,
  `dcforeligibility` varchar(255) DEFAULT NULL,
  `misleneous` varchar(255) DEFAULT NULL,
  `weightofcourier` varchar(255) DEFAULT NULL,
  `paymentmode` varchar(255) DEFAULT NULL,
  `ccno` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `tl_courierReciept`
--

LOCK TABLES `tl_courierReciept` WRITE;
/*!40000 ALTER TABLE `tl_courierReciept` DISABLE KEYS */;
/*!40000 ALTER TABLE `tl_courierReciept` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tl_student` (
  ...
  `entrollno` varchar(255) DEFAULT NULL,
  `name` varchar(255) DEFAULT NULL,
  ...
  `longmemo` varchar(255) DEFAULT NULL,
  `rcno` varchar(255) DEFAULT NULL,
  `date` varchar(255) DEFAULT NULL,
  `ddorcheck` varchar(255) DEFAULT NULL,
  `coursefee` varchar(255) DEFAULT NULL,
  `examfee` varchar(255) DEFAULT NULL,
  `centerfee` varchar(255) DEFAULT NULL,
  `applicationfee` varchar(255) DEFAULT NULL,
  ...
  `provisnal` varchar(255) DEFAULT NULL,
  `gendate` varchar(255) DEFAULT NULL,
  ...
  `sem7` varchar(255) DEFAULT NULL,
  `sem8` varchar(255) DEFAULT NULL,
...
INSERT INTO `tl_student` VALUES (1,'AndhraUniversity','BSC(Computers)','MCA0101010','Krishnakishore Punnavargula','KumarSwami','Kumari','31-03-1985','Hyderabad','9989898988','rayaprolu.ravikiran@gmail.com',NULL,'3121212112121','121192919191','192919191919','191919191','12-01-2015','28282828','128128128','12812812','21821812','1281281','121281','164165314','30000','164135314',NULL,NULL,'121212121',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `tl_student` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tl_university`
--

DROP TABLE IF EXISTS `tl_university`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tl_university` (
  `sno` bigint(20) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `tl_university`
--

LOCK TABLES `tl_university` WRITE;
/*!40000 ALTER TABLE `tl_university` DISABLE KEYS */;
INSERT INTO `tl_university` VALUES (1,'AndhraUniversity','BSC(Computers)','3000',NULL),(2,'AndhraUniversity','BSC','2000',NULL),(3,'AndhraUniversity','BSC(Computers)','3000',NULL),(4,'AndhraUniversity','BSC','2000',NULL),(5,'AndhraUniversity','BSC(Computers)','3000','SVSINFOMATICS');
/*!40000 ALTER TABLE `tl_university` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-09-11 18:28:13
