...
<div class="mainscreen" align="center">
	...
	<fieldset>
		<legend>
			Aging Of Account Recivable
		</legend>
		<form:form action="rep_fn_aging_of_account_recivable.fin" method="post" commandName="aggingaccountreceivableBean" target="_blank">
		<table>
			<tr>
				<td>
					From Date 
				...
				<td>	
					<form:input path="fromdate"  onfocus="showCalendarControl(this);" value="yyyy-mm-dd" required="true"/>
				</td>
				<td>
					To Date
				</td>
				<td>
					<form:input path="todate"  onfocus="showCalendarControl(this);" value="yyyy-mm-dd" required="true"/>
				</td>
				<td>
						Delt By
					</td>
