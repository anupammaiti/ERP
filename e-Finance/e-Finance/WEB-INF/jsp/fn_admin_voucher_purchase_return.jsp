...
<div class="mainscreen" align="center">
	...
	<fieldset>
		...
		<form:form action="rep_fn_orpurchase_returns.fin" method="post" commandName="vocherPurchaseReturnBean" target="_blank">
		<table>
				<tr>
					<td>
						Purchase Ledger
					...
					<td>
						<form:select path="purchaseledger" class="ledgerlist"></form:select>
					</td>
					<td>
						Item Name
					</td>
