...
<div class="mainscreen" align="center">
	...
	<fieldset>
		...
		<form:form action="rep_fn_invoice.fin" method="post" commandName="invoiceFormBean" target="_blank">
		<table>
				<tr>
					<td>
						Item Name
					...
					<td>
						<input type="text" name="ondate"  onfocus="showCalendarControl(this);" value="yyyy-mm-dd" required="true"/>
					</td>
					<td>
						Delt By
					</td>
