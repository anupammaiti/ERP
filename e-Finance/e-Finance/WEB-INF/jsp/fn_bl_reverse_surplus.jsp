...
// System.out.println("hi"+pwd);
 ...
 { %>
<body onLoad="viewReserveSurplus();">
<div class="mainscreen" align="center">
	...
	<table border="1" class="form_background">
			...
			<tr>
										<td>
											<a href="fn_bl_reverse_surplus_list.fin">Reserve Surplus</a>
										</td>		
										<td align="right">
											<div id="reserve_surplus"></div>
										</td>					
									</tr>
									<tr>
										<td>
										<a href="fn_bl_retain_earning_ledger_list.fin">Retained Earning</a>
										</td>
										<td align="right">
											<span id="retearning"></span>
										</td>
									</tr>
									<tr>
										<td>
