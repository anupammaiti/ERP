...
<div class="mainscreen" align="center">
	...
	<div class="content" align="center">
		...
		<fieldset>
			<legend>Advertisement Exp</legend>
		
		
		<form:form action="rep_fn_oradvertisement_exp.fin" method="post" commandName="advertisementExpenses" target="_blank">
			<table>
				<tr>
					<td>
						Ledger Name
