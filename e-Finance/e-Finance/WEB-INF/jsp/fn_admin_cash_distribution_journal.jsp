...
<div class="mainscreen" align="center">
	...
	<fieldset>
		<legend>Cash Distribute Journal</legend>
		<form:form action="rep_fn_cash_distribution_journal.fin" method="post" commandName="cashdisbursementsjournalBean" target="_blank">
		<table>
			<tr>
				<td>
					Ledger Name
