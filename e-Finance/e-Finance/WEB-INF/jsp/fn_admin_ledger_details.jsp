...
<script type="text/javascript">
	$(document).ready(function(){
		...
		var companyname=$('#companyid').val();
		$.get('fn_underListinLedger1.fin',{'companyname':companyname},function(data){
		//	alert(data);
			$('.under').html(data);
		});
	});</script>
...
<div class="mainscreen" align="center">
	...
	<form:form action="rep_fn_ledgerdetails.fin" method="post" commandName="ledgerDetailsBean" target="_blank">
		<table>
			<tr>
				<td>
					Ledger Name
				...
				<td>
					<form:select path="ledgername" class="ledgerlist"></form:select>
				</td>
				<td>
					Under
				</td>
				<td>
					<form:select path="under" class="under"></form:select>
				</td>
				<td>
					On
				</td>
				<td><input type="hidden" name="login_comp" id="companyid" value="<%=comp%>"/>
					<form:input path="getdate" onfocus="showCalendarControl(this);" value="yyyy-mm-dd" required="true"/>
				</td>
				<td>
