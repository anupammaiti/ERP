...
<div class="mainscreen" align="center">
	...
	<fieldset>
		<legend>Employee Pay Slip List</legend>
		<table align="center" border="1">
			...
			<c:forEach items="${PaySlipEmp}" var="emp1">
			<tr>
				<td>
					<a href="rep_fn_payslip.fin?sno=${emp1.sno}" target="_blank">${emp1.firstname}${emp1.lastname}</a>
				</td>
				<td>
					${emp1.mobileno}
				</td>
