...
<div class="mainscreen" align="center">
	...
	<c:forEach items="${StudentResultList}" var="std">
				...
				<td>
					<table>
						<tr>
							...
							<td>
								<img class="viewStudentImage"/>
							</td>
						</tr>
						<tr>
							<td>
							<span class="fieldlabel">	Father Name</span>
							</td>
							<td>	
							<span class="fieldresult">${std.fatherName}</span>
							</td>
						</tr>
						<tr>
							<td>
							<span class="fieldlabel">Mother Name</span></td>
							<td>	
							<span class="fieldresult">	${std.motherName}</span>
							</td>
						</tr>
						<tr>
							<td><span class="fieldlabel">Date Of Birth</span></td>
							<td>	
							<span class="fieldresult">	${std.dob}</span>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>	
							<span class="fieldresult">	${std.address}</span>
							</td>
						</tr>
						<tr>
							<td>
						...
						<tr></tr>
						<tr>
							<td><span class="fieldlabel">Provisional</span></td>
							<td>	
								<span class="fieldresult">${std.provisnal}</span>
							</td>
						
							<td><span class="fieldlabel">Migration</span></td>
							<td>	
								<span class="fieldresult">${std.migration}</span>
							</td>
						
							<td><span class="fieldlabel">OD</span></td>
							<td>	
								<span class="fieldresult">${std.od}</span>
							</td><td></td>
						</tr>
						<tr>	
							<td><span class="fieldlabel">Long Memo</span></td>
							<td>	
								<span class="fieldresult">${std.longmemo}</span>
							</td>
						
							<td><span class="fieldlabel">Other</span></td>
							<td>
								<span class="fieldresult">${std.other}</span>
							</td><td></td>
						</tr>
					</table>
				</td>
				...
				<td>	
					<table align="center" border="1">	
						<tr>
							...
							<td>
								<span class="fieldlabel">DD/Check</span>
							</td>
							<td>
								<span class="fieldlabel">Course Fee</span>
							</td>
							<td>
							<span class="fieldlabel">	Exam Fee</span>
							</td>
							<td>
							<span class="fieldlabel">	Center Fee</span>
							</td>
							<td>	
								<span class="fieldlabel">Application Fee</span>
							</td>
							<td>	
							<span class="fieldlabel">	Other Fee</span>
							</td>
							<td>
								<span class="fieldlabel">Total Fee</span>
							</td>
							<td>
							<span class="fieldlabel">	Paid</span>
							</td>
							<td>
						...
						<tr>
							...
							<td>	
								<span class="fieldresult">${std.ddorcheck }</span>
							</td>
							<td>	
								<span class="fieldresult">${std.coursefee }</span>
							</td>
							<td>	
								<span class="fieldresult">${std.examfee }</span>
							</td>
							<td>	
								<span class="fieldresult">${std.centerfee }</span>
							</td>
							<td>	
								<span class="fieldresult">${std.applicationfee}</span>
							</td>
							<td>	
								<span class="fieldresult">${std.otherfee }</span>
							</td>
							<td>	
								<span class="fieldresult">${std.totalpaid }</span>
							</td>
							<td>	
								<span class="fieldresult">${std.paid}</span>
							</td>
							<td>
