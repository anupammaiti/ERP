...
// System.out.println("hi"+pwd);
 ...
 { %>
<body onLoad=" viewCapitalAccount();">
<div class="mainscreen" align="center">
	...
	<fieldset>
		...
		<tr class="column_header">
			...
			<tr>
				<td>
					<a href="fn_bl_capital_account.fin">Capital Account</a>
				</td>
				<td>
					<span id="capitalaccount"></span>
				</td>
			</tr>
			<tr>
			
				<td>
					<a href="fn_bl_paid_up_shared_capital.fin">Paid Up Shared Capital</a>
				</td>
				<td>
					<span id="paidupsharedaccount"></span>
				</td>
			</tr>
			<tr>
				<td>
