...
<div class="mainscreen" align="center">
	...
	<form:form action="sfn_create_university.fin" method="post" commandName="universityBean">
	<table align="center">
		<tr>
			<td>
				University Name
			...
			<td>
				<form:input path="universityname"/>
				<form:errors path="universityname" cssClass="error"/>
			</td> 
		</tr>
		<tr>
			<td>
		...
		<tr>
			...
			<td>
				...
				<form:errors path="fees" cssClass="error"></form:errors>
			</td>
		</tr>
		<tr>
			<td>
