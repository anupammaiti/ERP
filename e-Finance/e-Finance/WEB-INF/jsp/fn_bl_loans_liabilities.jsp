...
// System.out.println("hi"+pwd);
 ...
 { %>
<body onLoad="viewLoansLiabilites();">
<div class="mainscreen" align="center">
	...
	<table border="1" class="form_background">
			...
			<tr>
				<td>
					<a href="fn_bl_loan_liabiliteslist.fin">Loans & Liabilites</a>
				</td>
				<td align="right">
			...
			<tr>
				<td>
					<a href="fn_bl_secured_loan_list.fin">Secured Loan</a>
				</td>
				<td align="right">
					<span id="secured_loan"></span>
				</td>
			</tr>
			<tr>
				<td>
					<a href="fn_bl_un_secured_loan_list.fin">UnSecured Loan</a>
				</td>
				<td align="right">
					<span id="unsecuredloan"></span>
				</td>
			</tr>
			<tr>
				<td>
