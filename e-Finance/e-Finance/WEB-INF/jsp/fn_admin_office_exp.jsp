...
<script type="text/javascript" src="js/resort_js.js">
...
<div class="mainscreen" align="center">
	...
	<div class="content" align="center">
			<fieldset>
				<legend>Office Exp</legend>
				
				
				<form:form action="rep_fn_oroffice_exp.fin" method="post" commandName="officeExp" target="_blank">
				<table>
					<tr>
						<td>
							Ledger Name
