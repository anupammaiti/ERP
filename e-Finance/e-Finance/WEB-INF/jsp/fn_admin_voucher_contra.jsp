...
<div class="mainscreen" align="center">
	...
	<fieldset>
		...
		<form:form action="rep_fn_orvouchercontra.fin" method="post" commandName="vocherContraBean" target="_blank">
		<table>
				<tr>
					<td>
						Particulars
					...
					<td>
						<form:select path="particular" class="ledgerlist"></form:select>
					</td>
					<td>
						Payment Date
					</td>
