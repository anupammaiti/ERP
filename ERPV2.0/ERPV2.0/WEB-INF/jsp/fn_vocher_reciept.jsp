...
<div id="my_popup"><a href="#" id="ledgerlink">Create Ledger</a></div>
 <fieldset>
 	<legend>Recipt</legend>
 	
 <form:form action="sfn_vocher_reciept.erp" method="post" commandName="recieptBean">
<table align="center" width="800" border="1" bgcolor="#FADFC3" bordercolor="#F0B269">
 ...
 <tr>
  ...
  <td width="392">
	<form:input path="reciptno" readonly="true" id="vocherreciptno"/>
