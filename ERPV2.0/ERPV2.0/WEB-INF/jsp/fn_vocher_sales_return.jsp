...
$(document).ready(function(){
	var counter=0;
	$.get('salesreturn.erp',function(data){
		
		if((data==null) ||(data==0))
			{
			$('#salesreturnreciptno').val(1).attr("readonly",true);
			}
		else{
			counter=parseInt(data)+1;
		
			$('#salesreturnreciptno').val(counter).attr("readonly",true);	
		}
	});
	return true;
});
...
<form:form action="sfn_vocher_sales_return.erp" method="post" commandName="vocherSalesReturnBean">
<table align="center" width="800" border="1" bgcolor="#FADFC3" bordercolor="#F0B269">
 <tr>
  ...
  <td width="392">
<form:input path="reciptno" id="salesreturnreciptno"/>
