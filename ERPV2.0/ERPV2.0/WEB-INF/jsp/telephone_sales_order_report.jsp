...
<fieldset>
<legend class="text1"><b>Telephone Sales Order Report</b></legend>
<table>
<tr>
	<td>
		Custormer Name
...
<c:forEach items="${telorderlist}" var="teleorderlist" varStatus="status">
	<tr>
		<td>
			<c:out value="${teleorderlist.customer}"></c:out>
		</td>
	</tr>
</c:forEach>
</table>
