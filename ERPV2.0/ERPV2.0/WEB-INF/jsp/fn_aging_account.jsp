...
<fieldset>
	<legend>Aging Account </legend>
<form:form action="sfn_aging_account.erp" method="post" commandName="agingAccountBean">
    ...
    <table align="center" border="1" bordercolor="#F0B269" bgcolor="#FADFC3" width="800">
	 ...
	 <tr>
	  ...
	  <td>
	   ...
	   <td>
	  	<form:input path="monthly" size="10"/>
	    
	   </td>
	   <td>
	    <form:input path="monthly2" size="10"/>
	    	
	    </td>
		<td>
		<form:input path="monthly3" size="10"/>
		 
		</td>
		<td>
			<form:input path="total" size="10"/>
