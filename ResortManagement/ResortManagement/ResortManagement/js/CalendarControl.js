...
//if((dt.getCurrentDay() != day) || (dt.getCurrentMonth() != month-1) || (dt.getCurrentYear()!=year) || (dt<today))	
		if(calendarControl.setDate < today)
		{
			calendarControl.clearDate();
		}
