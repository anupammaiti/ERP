...
<body>
	...
	<div class="main_screen" align="center">
		...
		<fieldset>
			...
			<form:form action="updateGuestByTeleManager.res" method="post" commandName="guestUserBean">
			...
			<table>
				...
				<tr>
					...
					<td>
						<form:input path="department" value="${guestuserlist.department}" readonly="true" id="department"/>
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					...
					<td>
						<form:select path="refered1" id="refe1"></form:select>
