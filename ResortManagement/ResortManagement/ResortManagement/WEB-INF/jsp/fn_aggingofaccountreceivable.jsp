...
<div class="mainscreen" align="center">
	...
	<jsp:include page="fn_executive_header.jsp" flush="false"></jsp:include>
	</div>
	<div class="content" align="center">
<fieldset><legend>Agging Of Account Receivable</legend>
<form:form action="sfn_aggingaccounreceivable.res" method="post" commandName="aggingaccountreceivableBean">
