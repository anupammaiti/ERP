...
<form:form action="sfn_hotel_exp.res" method="post" commandName="hotelExpensesBean"> 
  ...
  <tr>
   <td>
    <table align="center" border="1" width="800">
	 ...
	 <tr>
	  <td>
	   <form:input path="date1" size="20px" onfocus="showCalendarControl(this);" readonly="true"/>
	   </td>
	    <td width="543">
	 ...
	 <form:input path="noofdays" id="noofdays"/>
	   ...
	   <td>
	    <form:input path="hotellocation"/>
	   </td>
	   
	  
	   <td>
	   <form:input path="amountperday" id="amountperday"/>
	   </td>
	   <td>
