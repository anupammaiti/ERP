...
<table align="center" class="form_table">
	<tr>
	<td>
		<form:form action="sl_saved_invoice.res" method="post" commandName="invoiceFormBean" id="invoice_form"> 
...
<table align="center"  cellspacing="0" cellpadding="0">
   ...
   <tr>
    <td>
	 ...
	 <form:input path="srlno" onblur="return numeric(this.value);" class="number"/>
	 </td>
	 <td>
	  
	  <form:input path="name" onblur="return alphabetic(this.value);" class="name"/>
	 </td>
	 <td>
	  
	  <form:input path="unitprice" id="price" onblur="return numeric(this.value);" class="number"/>
	 </td>
	 <td>
	    <form:input path="quantity" id="quantity" class="number"/>
	 </td>
