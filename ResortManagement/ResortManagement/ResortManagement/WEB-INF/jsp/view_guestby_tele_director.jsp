		...
		<fieldset>
				...
				<table cellpadding="3px" cellspacing="4px" border="1px">
					<tr class="column_header">
						...
						<c:forEach items="${guestbyteledirectorlist}" var="guestuser" varStatus="status">
					
					<tr>
						
						<td>
							
						<c:out value="${guestuser.guest_name}"/>
						</td>
						<td>
						...
						<td>
							<c:out value="${guestuser.designation}"/>
						</td>
						<td>
				...
				Note: List of guest alloted to the manager by Admin.
			</fieldset>	
		</div>
