...
<div id="loginby"><span ><b>Welcome </b>: <i><%=username%></i></span><div class="flip"><ul><li><a href="#">Log Out</a></li></ul> </div></div>
...
<div id="menu" align="left">
    <ul class="menu">
       ...
       <div>
       	<ul>
       		<li>
       			<a href="fn_view_executive_by_managers.res"><span>Employee Details</span></a>		
       		</li>
       ...
       <li>
       	...
       	<div>
       		<ul>
       			<li>
       				<a href="view_customer_by_finance_manager.res"><span>Alloted Customer</span></a>
       			</li>
       			<li>
       				<a href="fn_view_customer_installments_by_manager.res"><span>Customer Installments</span></a>
       			</li>
       ...
       <li>
       		...
       		<ul>
       			...
       			<li>
       				...
       				<div>
       					<ul>
       						<li>
        						<a href="fn_search_invoice_by_manager.res"><span>Invoice</span></a>
       					...
       					<ul>
       						<li>
       							...
       							<div>
       								<ul>
       									<li>
       										<a href="fn_search_travel_exp_by_manager.res"><span>Auto Expenses</span></a>
       									</li>
       									<li>
       										<a href="fn_search_phone_bill_exp_by_manager.res"><span>Phone Bill</span></a>
       									</li>
       									<li>
       										<a href="fn_search_food_bill_exp_by_manager.res"><span>Food Expenses</span></a>
       									</li>
       									<li>
       										<a href="fn_search_hotel_exp_by_manager.res"><span>Hotel Expenses</span></a>
       									</li>
       									<li>
       										<a href="fn_search_entertainment_exp_by_manager.res"><span>Entertainment Expenses</span></a>
       									</li>
       									<li>
       										<a href="fn_search_misleneous_exp_by_manager.res"><span>Mis Expenses</span></a>
       									</li>
       									<li>
        				...
        				<div>
        					...
        					<li>
        						...
        						<div>
        							<ul>
        								<li>
        									<a href="fn_mng_voucher_reciept.res"><span>Reciept</span></a>
        								</li>
        								<li>
        								...
        								<ul>
        									<li>
        										...
        										<div>
        											<ul>
        												<li>
        													<a href="fn_mng_ledger.res"><span>Ledger</span></a>
        												...
        												<li>
        													<a href="fn_mng_group.res"><span>Groups</span></a>
        									...
        									<li>
        										...
        										<div>
        											<ul>
        												<li>
        													<a href="fn_mng_stockGroup.res"><span>Stock Groups</span></a>
       	...
       	<li>
       		...
       		<div>
       			<ul>
       				<li>
       				<a href="fn_manager_edit_password.res"><span>Edit Password</span></a>	
       				</li>
       				<li>
