...
<!--                        <table border="1px"> 
                        ...
                        <c:forEach items="${fncustomer}" var="fncust" varStatus="status">
                            <tr>
                                <td>
                                    ...
                                    <td>
                                    <c:out value="${fncust.department}"></c:out>
                                    </td>
                                    <td>	
                                    <c:out value="${fncust.manager}"></c:out>
                                    </td>
                                    <td>
                    ...
                    <div id="customerInstallmentAdminGrid"></div>
        ...
        <script>
            $(document).ready(function(){
                initCustomerInstallmentAdmin();
               customerInstallmentAdmin(); 
            });
        </script>
    </body>
</html>
