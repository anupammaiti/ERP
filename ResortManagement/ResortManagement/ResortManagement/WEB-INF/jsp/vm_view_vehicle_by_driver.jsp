...
<body>
	...
	<div class="main_screen" align="center">
		<div class="menu" align="left">	
			<jsp:include page="vehicle_maintenence_header.jsp" flush="true"></jsp:include>
		</div>
		<div class="content" align="center">
			<fieldset>
				...
				<table cellpadding="2px" cellspacing="9px" border="1px">
					...
					<c:forEach items="${VDByDriver}" var="vehicledetails" varStatus="status">
					<tr>
						<td>
