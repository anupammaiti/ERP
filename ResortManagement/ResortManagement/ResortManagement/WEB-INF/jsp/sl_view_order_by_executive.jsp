		...
		<div class="content" align="center">
			<fieldset>
				...
				<table border="1">
					...
					<c:forEach items="${slorderbyexecutiveList}" var="slorder" varStatus="status">					
					<tr>
						<td>
							<a href="rep_sl_orderform_by_executive_list.res?sno=${slorder.sno}" target="_blank"><c:out value="${slorder.number}"/></a>
						</td>
						<td>
