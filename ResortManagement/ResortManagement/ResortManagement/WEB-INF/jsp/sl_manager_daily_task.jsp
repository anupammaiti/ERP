	...
	<div class="main_screen" align="center">
		...
		<div class="content" align="center">
			<fieldset>
				...
				<table>
				<form:form action="rep_sl_taskmanager.res" method="get" commandName="salesManagerTastBean" target="_blank">
							...
							<tr>
								...
								<td>
									<form:input path="date1" onfocus="showCalendarControl(this);" value="yyyy-mm-dd"/>
								</td>
					...
					<form:form action="rep_sl_manager_daily_task.res" method="get" commandName="salesManagerTastBean" target="_blank">
					<tr>
						<td>
							Date:
						</td>
