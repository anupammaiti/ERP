				...
				<table cellspacing="0" cellspacing="0" border="1px">
					...
					<tr>
						<td>
							...
							<a href="sl_allot_customer_by_manager.res?id=<c:out value="${customer.sno}"></c:out>"><c:out value="${name}"></c:out></a>
						</td>
						<td>
							<c:out value="${customer.mobileno}"></c:out>
						</td>
						<td>
						...
						<td>
							<c:out value="${customer.sle_id }"></c:out>
						</td>						
					</tr>
					</c:forEach>
					  
				</table><br/>
				<b>Note</b>: Click on Customer Name you can get the allotting form for  Sales Executive to the Customer.
			</fieldset>
		</div>
