	...
	<div class="main_screen" align="center">
		...
		<div class="content" align="center">
			<fieldset>
				...
				<table cellspacing="0" cellspacing="0" border="1px" class="tab1">
					...
					<tr>
						<td>
							...
							<a href="sl_customer.res?id=<c:out value="${customer.sno}"></c:out>"><c:out value="${name}"></c:out></a>
						</td>
						<td>
				...
				<b>Note</b>:Click on Customer Name you can go to the Sales Customer Form, Click on Mobile No You can get the Customer Report. 
			</fieldset>
		</div>
