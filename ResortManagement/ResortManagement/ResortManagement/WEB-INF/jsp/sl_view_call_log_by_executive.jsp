...
<body>
	...
	<div class="main_screen" align="center">
		...
		<div class="content" align="center">
			<fieldset>
				<legend>SalesLog List By Executive</legend>
				<table border="1">
					...
					<c:forEach items="${salescallloglist}" var="slcalllog" varStatus="status">			
					<tr>
						<td>
						<a href="rep_sl_SalesLogList_by_executive_list.res?sno=${slcalllog.sno }" target="_blank"><c:out value="${slcalllog.number}"/></a>
						</td>
						<td>
