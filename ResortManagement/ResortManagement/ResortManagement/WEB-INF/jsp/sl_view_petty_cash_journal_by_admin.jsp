...
<body>
	...
	<div class="main_screen" align="center">
		...
		<table border="1">	
					...
					<c:forEach items="${slpetjbdir}" var="slpettycash" varStatus="status">
					<tr>	
						<td>
							<c:out value="${slpettycash.department}"></c:out>					
						</td>
						<td>
						...
						<td>
							<c:out value="${slpettycash.manager }"></c:out>
						</td>
						<td>
							<c:out value="${slpettycash.deltby }"></c:out>
						</td>
					</tr>
					</c:forEach>
				</table>
