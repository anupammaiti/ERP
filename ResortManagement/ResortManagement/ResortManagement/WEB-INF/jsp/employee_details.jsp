                        ...
                        <table cellpadding="3px" cellspacing="7px">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form:input path="firstname" onblur="return alphabetic(name.value);" required="true"/>
                                </td>
                                ...
                                <td>
                                    <form:input path="lastname" onblur="return alphabetic(name.value);" required="true"/>
                                </td>
                                <td>	
                                    Date Of Birth:
                                </td>
                                <td>	
                                    <form:input path="dateofbirth" value="yyyy-mm-dd" required="true" id="dob"/>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form:input path="email" size="42" required="true"/>
                                </td>
                                <td>
                                    Mobile:
                                </td>
                                <td>
                                    <form:input path="mobile" onblur="return numeric(this.value);" required="true"/>
                                </td>
                                <td>
                                    Land Line:
                                </td>
                                <td>
                                    <form:input path="land_line" onblur="return numeric(this.value);" required="true"/>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <form:input path="pincode" onblur="return numeric(this.value);" required="true"/>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <form:input path="expectedsalary" onblur="return numeric(this.value);" required="true"/>
                                </td>
                                <td>
                                    Bank Account No:
                                </td>
                                <td>
                                    <form:input path="bankaccountno" onblur="return numeric(this.value);" required="true"/>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form:input path="pannumber" onblur="return alphanumeric(this.value);" required="true"/>
                                </td>
                                <td>
                                    Passport Number:
                                </td>
                                <td>
                                    <form:input path="passportnumber" onblur="return numeric(this.value);" required="true"/>
                                </td>
                                <td>
                                    Passport Exp dt:
                                </td>
                                <td>
                                    <form:input path="passportexpirydate" required="true"/>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <form:input path="username" id="user_id" required="true"/>
                                </td>
                                <td>
                                </td>
                                <td>
