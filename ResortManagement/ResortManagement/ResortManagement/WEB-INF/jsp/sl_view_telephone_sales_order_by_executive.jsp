		...
		<div class="content" align="center">
			<fieldset>
				...
				<table border="1">
					...
					<c:forEach items="${telephonesalesorderbyexecutive}" var="slpolist" varStatus="status">
					<tr>
						<td>
							<c:out value="${slpolist.toaddress}"/>
						</td>
						<td>
							<a href="rep_sl_TelephoneSalesOrder_by_executive_list.res?sno=${slpolist.sno}" target="_blank"><c:out value="${slpolist.customer}"/></a>
						</td>
						<td>
