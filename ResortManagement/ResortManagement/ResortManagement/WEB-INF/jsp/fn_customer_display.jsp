...
<body>
	...
	<div class="main_screen" align="center">
		...
		<div class="content" align="center">
			<fieldset>
				<legend>
					View List of Finance Customers
				</legend>
				<table border="1px"> 
					...
					<tr>
						<td>
							<a href="update_installments.res?id=<c:out value="${fncust.id}"></c:out>"><c:out value="${fncust.custid}"></c:out></a>
						</td>
						<td>
							<c:out value="${fncust.totalamount}"></c:out>
						</td>
						<td>
							<c:out value="${fncust.remainingamount}"></c:out>
						</td>
						<td>
						...
						<td>
							<c:out value="${fncust.installment_date}"></c:out>
						</td>
					</tr>
					</c:forEach>
				</table><br/>
