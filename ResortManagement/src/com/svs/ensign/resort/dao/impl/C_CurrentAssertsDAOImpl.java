...
public class C_CurrentAssertsDAOImpl implements IN_CurrentAssertDAO {
	...
	private String isavailablequery="from CurrentAssertsBean cab where cab.ledgername=? and cab.under=?";
	...
	public boolean updateCurrentAsserts(String ledgername, String balance,
		...
		// TODO Auto-generated method stub
		try{
			Query updatequery=session.createQuery("update CurrentAssertsBean cab set cab.under=:under,cab.balance=:balance where cab.ledgername=:ledgername");
	...
	public boolean isAvailable(String ledgername,String under) {
		// TODO Auto-generated method stub
			currentassertlist=ht.find(isavailablequery,ledgername,under);
	...
	public boolean isAvalable(String ledgername) {
		// TODO Auto-generated method stub
		currentassertlist=ht.find("from CurrentAssertsBean cab where cab.ledgername=?",ledgername);
		//System.out.println("Current Asserts List\t"+currentassertlist.size());
