...
<table class="tab10" width="98%"> <tr align="center">
   <td align="center" class="head"><h3>Half Day Absentees Report<br><br><br></td>
	</tr></table>


<table border="0" bordercolor="#D468F7"   align="center" bgcolor="#A4C6C5" width="98%">
<form action="Halfdayreport" name="frm11" method="get" target="_blank" onSubmit="return datediff();">
   <tr align="right">
   <td width="500">
