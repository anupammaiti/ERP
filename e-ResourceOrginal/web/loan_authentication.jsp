...
<c:forEach var="employee" items="${employeeList}">
 <tr 
  onMouseOver="this.className='highlight'" onMouseOut="this.className='normal'" class="tr1">
	<td>
		 <a href="leave_authentication_by_hr_admin.jsp?empid=${employee.empid}" id="anchorcolor" title="Click Here To View Details"><img src="images/report1.png" align="absmiddle">${employee.empid}</a>
	</td>
	<td>
		${employee.loanamount}
	</td>
