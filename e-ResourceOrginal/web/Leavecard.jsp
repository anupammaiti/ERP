...
<table class="tab10" width="98%"> <tr align="center">
   <td align="center" class="head"><h3>Employee Leave Card<br><br><br><br><br><br></td>
	</tr></table>

<table border="0" bordercolor="#D468F7"   align="center" class="tab10" width="98%">
<form action="Leavecardsearch3.jsp" name="frm11" method="post" onSubmit="return datediff();">
   <tr align="right">
   <td width="500">
   ...
   <td width="500">
	  ...
	  </strong><img src="images/date.png" align="absmiddle"><font color="#FF0000">*</font>
