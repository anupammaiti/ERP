...
function nextpage()
 ...
 // alert("youclocked");
  //alert("hiiiiiiiiiiiiiii");
         var a=document.frm11.empno.value;
		//alert(a);
			...
			//	  alert(b);
						 ...
						 //  alert(c);
       //alert(a);
	   var d="Viewing leave application status OK";
	  //alert(b);
...
document.frm11.fromdate.focus();
document.frm11.fromdate.style.background = "navy";
document.frm11.fromdate.style.color="#FFFFFF";
return false;
}
else if(c=="")
{
alert("Please Enter From Date");
document.frm11.todate.focus();
document.frm11.todate.style.background = "navy";
document.frm11.todate.style.color="#FFFFFF";
return false;
}
else
{
		document.frmreject.action="Leavecardstatus?COdeof employee for leave status="+d+"&empid1="+a+"&fromdate="+b+"&todate="+c+"";
}
  }
</script>
...
String comp=(String)session.getAttribute("comp");
  ...
  //~~~~~~~~~~~~~~~~`code to find user is RM or NOT
	...
	try
		{
			//////System.out.println("LeavecardforEMP.jsp::ConnectionPool----->>>>Before Open --->>>>Test");
			con=connectionUtils.getDBConnection();
			//////System.out.println("LeavecardforEMP.jsp::ConnectionPool----->>>>After Open --->>>>Test");
...
<table class="tab10" width="98%"> <tr align="center">
   <td align="center" class="head"><h3> Leave Card<br><br><br></td>
	</tr></table>

<table border="0" bordercolor="#D468F7"   align="center" class="tab10" width="98%">
<form action="LeavecardsearchforEMP" name="frm11" method="post" onSubmit="return datediff();">
   <tr align="center">
	...
	<td width="400" align="left">
	  <input type="text" name="empno" class="empidtext1" readonly="true" size="14" value="<%=user_name%>"></font>
	  </td>
	 </tr>
	 <tr align="center">
	 <td width="320"></td>
	...
	<td width="400" align="left">
	 ...
	 <td></td>
<td ><input type="image" src="images/ls2.png" onFocus="return check()"></td> </form>
<td align="left">
  <form name="frmreject" method="post">
	   <input type="image" src="images/ls1.png"  onClick="return nextpage();"> 
</form></td>
    </tr>
</table>
<tr>
...
<%
	}catch(Exception ex)
		{
		 //////System.out.println(ex);
			...
			try
			{
				//////System.out.println("LeavecardforEMP.jsp::ConnectionPool--Before Close --->>>>Test");
				if (con != null) connectionUtils.setDBClose();
				//////System.out.println("LeavecardforEMP.jsp::ConnectionPool--After Close--->>>>Test");
