...
<table class="tab10" width="98%"> <tr align="center">
   <td align="center" class="head"><h3>Late Coming Employees Report<br><br><br></td>
	</tr></table>


<table border="0" bordercolor="#D468F7"   align="center" class="tab10" width="98%">
<form action="AllEmployeeLatecoming" name="frm11"  onSubmit="return datediff();" target="_blank">
