...
<table class="tab10" width="98%"> <tr align="center">
   <td align="center" class="head"><h3>Loan Details<br><br><br></td>
	</tr>
	<tr><td>
	<h4 id="message">${message}</h4>
	<form action="LoanApplyFormBO" method="post">
		<table align="center">
			<tr>
				<td>
					Employee Id
				...
				<td>
					<input type="text" name="empid" value="<%=user_name%>" readonly="true"/>
				</td>
			...
			<tr>
				...
				<td>
					<input type="text" name="loanamount" id="loan_amount"/>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="text" name="noofmonths" id="noofmonths"/>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<input type="text" name="monthlyamount" id="monthly_amount"/>
				</td>
			</tr>
			<tr>
				<td>
