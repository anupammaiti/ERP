...
<body onLoad="displayCompanyPaySlip();">
...
if((user_name!=null)&&(pwd!=null))
{
 ...
 <input type="hidden" value="SVSINFOMATICS" id="companyname"/>
...
<!-- Content Started. -->
					...
					<form action="updateCompanyPaySlip" method="post">
				...
				<td align="center">
					...
					<tr>
						...
						<tr> <td align="center"> <b>slab1</b></td>
						 <td>
						 <input type="text" name="mis1" id="mis1"/>
						 
						 </td>
						 <td>
						 <input type="text" name="mie1" id="mie1"/>
						 </td>
						 <td>
						 <input type="text" name="mip1" id="mip1"/>
						 </td> 
						 </tr>

						<tr> <td align="center"> <b>slab2</b></td> 
						<td>
						<input type="text" name="mis2" id="mis2"/>
						</td>
						<td>
						<input type="text" name="mie2" id="mie2"/>
						</td> 
						<td>
						<input type="text" name="mip2" id="mip2"/>
						</td> 
						</tr>

						<tr> <td align="center"><b>slab3</b></td>
						 <td>
						 <input type="text" name="mis3" id="mis3"/>
						 </td> 
						 <td>
						 <input type="text" name="mie3" id="mie3"/>
						 </td> 
						 <td>
						 <input type="text" name="mip3" id="mip3"/>
						 </td> 
						</tr>

						<tr><td align="center"><b> slab4</b></td> 
						<td>
						<input type="text" name="mis4" id="mis4"/>
						</td> 
						<td>
						<input type="text" name="mie4" id="mie4"/>
						</td>
						 <td>
						 <input type="text" name="mip4" id="mip4"/>
						 </td>
					   </tr>
						...
						<tr> <td align="center"> <b>slab1</b></td>
						<td>
						<input type="text" name="fis1" id="fis1"/>
						</td> 
						<td>
						<input type="text" name="fie1" id="fie1"/>
						</td> 
						<td>
						<input type="text" name="fip1" id="fip1"/>
						</td>
						</tr>

						<tr> <td align="center"><b> slab2</b></td> 
						<td>
						<input type="text" name="fis2" id="fis2"/>
						</td> 
						<td>
						<input type="text" name="fie2" id="fie2"/>
						</td> 
						<td>
						<input type="text" name="fip2" id="fip2"/>
						</td>
						</tr>

						<tr> <td align="center"><b> slab3</b></td> 
						<td>
						<input type="text" name="fis3" id="fis3"/>
						</td> 
						<td>
						<input type="text" name="fie3" id="fie3"/>
						</td> 
						<td>
						<input type="text" name="fip3" id="fip3"/>
						</td>
						 </tr>

						<tr> <td align="center"> <b>slab4</b></td> 
						<td>
						<input type="text" name="fis4" id="fis4"/>
						</td> 
						<td>
						<input type="text" name="fie4" id="fie4"/>
						</td> 
						<td>
						<input type="text" name="fip4" id="fip4"/>
						</td> 
						</tr>
