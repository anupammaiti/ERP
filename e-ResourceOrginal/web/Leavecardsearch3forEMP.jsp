...
String comp=(String)session.getAttribute("comp");
  ...
  //~~~~~~~~~~~~~~~~`code to find user is RM or NOT
	...
	try
		{
			//////System.out.println("Leavecardsearch3forEMP.jsp::ConnectionPool----->>>>Before Open --->>>>Test");
			conn=connectionUtils.getDBConnection();
			//////System.out.println("Leavecardsearch3forEMP.jsp::ConnectionPool----->>>>After Open --->>>>Test");
   ...
   while(rs.next())
	 ...
	 %>
	   ...
	   <tr   onMouseOver="this.className='highlight'" onMouseOut="this.className='normal'" class="tr1">
		...
		<td width="97">
      <a href="Leavecard?empno=<%=rs.getString(1)%>" target="_blank"  id="anchorcolor" title="Click Here To View Report"><img src="images/report1.png" align="absmiddle">&nbsp;<%=rs.getString(1)%></a>
</td>
...
out.println("Exception"+ex);
			...
			try
			{
				//////System.out.println("Leavecardsearch3forEMP.jsp::ConnectionPool--Before Close --->>>>Test");
				if (conn != null) connectionUtils.setDBClose();
				//////System.out.println("Leavecardsearch3forEMP.jsp::ConnectionPool--After Close--->>>>Test");
