...
<table class="tab10" width="98%"> <tr align="center">
   <td align="center" class="head"><h3>Emloyee Total Attendance Report<br><br><br></td>
	</tr></table>


<table border="0" bordercolor="#D468F7"   align="center" class="tab10" width="98%">
<form action="Totalattandancesearch3.jsp" name="frm11" method="post" onSubmit="return datediff();">
   <tr align="right">
   <td width="500">
