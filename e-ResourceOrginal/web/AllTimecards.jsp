...
<table class="tab10" width="98%"> <tr align="center">
   <td align="center" class="head"><h3>All Emplpoyees Time Cards <br><br><br></td>
	</tr></table>


<table border="0" bordercolor="#D468F7"   align="center" bgcolor="#A4C6C5" width="98%" >
<form action="AllTimecards" name="frm11" target="_blank" onSubmit="return datediff();">
  <!-- <tr align="right">
   <td width="500">
	...
	<td width="500" align="left">
	 <font color="#006600" size="4"><strong><font color="#573801" size="2" face="Verdana">Emp No</font></strong>
   ...
   <td width="500">
	...
	<strong><font color="#000066" size="2" face="Verdana">To Date</font>
	 ...
	 <tr align="center">
<td class="t1"></td><td class="t1"><br><input type="image" src="images/submit_btn.png" onFocus="return check()"></td>
    </tr>
  </form>
</table>
<tr>
