...
<input type="hidden" value="<%=empid%>" id="empno"/>
  ...
  <script type="text/javascript">
  	$(document).ready(function(){
  		...
  		//alert('Leave Types');
  		$.get('LeaveTypes',{'empid':empno,'comp':comp },function(data){
  			//alert('Leave Types'+data);
  			var data1=data;
  			$('.leavetypes').append(data1);
  		});
  		//alert('Leave List');
  		$.get('LeavesList',{'empid':empno,'comp':comp},function(data){
...
<table class="tab10" width="98%" border="0"> <tr align="center">
   <td align="center" class="head"><h3>Permissions Approve Form</h3><br></td>
	</tr>
	<tr><td>
   ...
   <table align="center"  border="0" bgcolor="#A4C6C5">
	...
	<tr>
	 <td  align="center">
	  ...
	  <td align="center"><font color="#000066" size="2"> Time</font></td>
	...
	<tr>
		...
		<select name="leavetype" onMouseOver="this.className='highlight1'" onMouseOut="this.className='normal1'" class="leavetypes" id="leavetype" onChange="swap();" >
...
<option value="OD">On Duty</option>
 ...
 <td align="center"><img src="images/date.png" align="absmiddle">
  <input type="text" name="date2" id="date2" size="12" onfocus="showCalendarControl(this),showCustomer(date1.value,employeecode.value);" readonly="true" >
 </td>
		<td ><input type="text" name="odhours" id="odhours" onFocus="clear1();" size="8" style="display:none;" value="HH:MM:SS" > </td>
