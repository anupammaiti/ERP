...
<% session.setAttribute("username",user_name);
  ...
  String query;
   ...
   //Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/hrerp","root","root");
	...
	try
		{
			//////System.out.println("Totalattadancesearch3.jsp::ConnectionPool----->>>>Before Open --->>>>Test");
			conn=connectionUtils.getDBConnection();
			//////System.out.println("Totalattadancesearch3.jsp::ConnectionPool----->>>>After Open --->>>>Test");
...
<%
		...
		//////System.out.println(ex);
			...
			try
			{
				//////System.out.println("Totalattadancesearch3.jsp::ConnectionPool--Before Close --->>>>Test");
				if (conn != null) connectionUtils.setDBClose();
				//////System.out.println("Totalattadancesearch3.jsp::ConnectionPool--After Close--->>>>Test");
