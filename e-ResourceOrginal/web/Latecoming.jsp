...
var c=document.frm11.time.value;
if(c=="HH:MM:SS"||c=="")
{
...
var d=document.frm11.empname.value;
var e=document.frm11.empno.value;
if(d==""&&e=="")
{
alert("Please Specify Emp Name (or) Number.");
//document.frm11.empname.focus();
document.frm11.empname.style.background = "pink";
//document.frm11.time.focus();
document.frm11.empno.style.background = "pink";
return false;
}
}
</script>
...
<style type="text/css"> 
			...
			.wrapper{ width: 975px;  padding: 8px; margin: 0 auto; background-color:#DEECFD; }
			.wrapper1{ width: 975px;  padding: 8px; margin: 0 auto; background-color:#DEECFD;}
			...
			/* css for timepicker */
			.ui-timepicker-div .ui-widget-header { margin-bottom: 8px; color:#CC6600; }
...
String comp=(String)session.getAttribute("comp");
 //////System.out.println("User in Late Coming"+user_name);
...
<table class="tab10" width="98%"> <tr align="center">
   <td align="center" class="head"><h3>Late Coming Report of Employee<br><br><br></td>
	</tr></table>


<table border="0" bordercolor="#D468F7"   align="center" class="tab10" width="98%">
<form action="Latecomingsearch3.jsp" name="frm11" method="post" onSubmit="return datediff();">
   <tr align="right">
   <td width="500">
	  <strong><font color="#000066" size="2" face="Verdana">Name</font>
	  </strong><font color="#006600" size="4">
	  <input type="text" name="empname" ></font>
	</td>
   ...
   <td width="500">
	...
	<div>
	 ...
	 <font color="#006600" size="4"><strong><font color="#000066" size="2" face="Verdana">Time</font></strong>
	 
	  <input type="text" name="time" id="time" onFocus="clear1();" size="10"  value="HH:MM:SS"></font>
	  </div>
...
<tr>
    <td align="center">
		<!--<table width="98%" class="tab10"><tr id="svstr"><td align="right"><br><br><br><br>&copy;Powered by <a href="http://www.svsinfomatics.com" target="_blank" id="svs"><font>SVSINFOMATICS</font></a></td></tr></table>-->
		<br>
