...
String comp=(String)session.getAttribute("comp");
 ...
 if(pwd!=null)
 {
  //~~~~~~~~~~~~~~~~`code to find user is RM or NOT
	...
	try
		{
			//////System.out.println("TotalattandancereportforEMP.jsp::ConnectionPool----->>>>Before Open --->>>>Test");
			con=connectionUtils.getDBConnection();
			//////System.out.println("TotalattandancereportforEMP.jsp::ConnectionPool----->>>>After Open --->>>>Test");
...
<table class="tab10" width="98%"> <tr align="center">
   <td align="center" class="head"><h3>Total Attendance Report<br><br><br></td>
	</tr></table>


<table border="0" bordercolor="#D468F7"   align="center" class="tab10" width="98%">
<form action="TotalattandancesearchforEMP" name="frm11" method="post" onSubmit="return datediff();">
   <tr align="center">
	...
	<td width="400" align="left">
	  <input type="text" name="empno" class="empidtext1" value="<%=user_name%>" size="14" readonly="true"></font>
	 </td>
	 </tr>
	 <tr align="center">
	 <td width="320"></td>
...
<%
		...
		//////System.out.println(ex);
			...
			try
			{
				//////System.out.println("TotalattandancereportforEMP.jsp::ConnectionPool--Before Close --->>>>Test");
				if (con != null) connectionUtils.setDBClose();
				//////System.out.println("TotalattandancereportforEMP.jsp::ConnectionPool--After Close--->>>>Test");
