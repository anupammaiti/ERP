...
<table class="tab10" width="98%"> <tr align="left">
  <td><span><a href="#" id="allemployeepayslip">GeneratePaySlip For All Employee</a></span></td> <td align="center" class="head"><h3>All Employees For PaySlip<br></td>
	</tr></table>
...
<b>Company</b>
  ...
  onMouseOver="this.className='highlight'" onMouseOut="this.className='normal'" class="tr1">
		<td>
			<a href="emp_payroll_by_admin.jsp?empid=${employee.empid}" target="_blank"id="anchorcolor" title="Click Here To View Details"><img src="images/report1.png" align="absmiddle">${employee.empid}</a>			
		</td>
		<td>
			<a href="RepFinalPaySlipByEmployee?id=${employee.empid}" id="anchorcolor" title="Click here for PaySlip" target="_blank">${employee.empname}</a>
		</td>
		<td>
			${employee.dob}
		</td>
        ...
        <tr>
            <c:forEach begin="1" end="${noOfPages}" var="i">
                <c:choose>
                    ...
                    <c:otherwise>
                        <td><a href="employee_details_for_payslip.jsp?page=${i}">${i}</a></td>
                    </c:otherwise>
                </c:choose>
            </c:forEach>
        </tr>
