...
<table class="tab10" width="98%"> <tr align="center">
   <td align="center" class="head"><h3>Employee Total Attendance Summary Report<br><br><br></td>
	</tr></table>
  ...
  // Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/hrerp","root","root");
	...
	try
		{
			//////System.out.println("Totalattandancesummarysearch3.jsp::ConnectionPool----->>>>Before Open --->>>>Test");
			conn=connectionUtils.getDBConnection();
			//////System.out.println("Totalattandancesummarysearch3.jsp::ConnectionPool----->>>>After Open --->>>>Test");
   ...
   while(rs.next())
	 ...
	 %>
	   ...
	   <tr   onMouseOver="this.className='highlight'" onMouseOut="this.className='normal'" class="tr1" >
		...
		<td>
      <a href="Totalattandancesummary?empno=<%=rs.getString(1)%>" target="_blank"  id="anchorcolor" title="Click Here To View Details"><img src="images/report1.png" align="absmiddle">&nbsp;<%=rs.getString(1)%></a>
</td>
...
<%
		...
		//////System.out.println(ex);
			...
			try
			{
				//////System.out.println("Totalattandancesummarysearch3.jsp::ConnectionPool--Before Close --->>>>Test");
				if (conn != null) connectionUtils.setDBClose();
				//////System.out.println("Totalattandancesummarysearch3.jsp::ConnectionPool--After Close--->>>>Test");
