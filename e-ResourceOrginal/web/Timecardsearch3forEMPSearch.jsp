...
<table class="tab10" width="98%"> <tr align="center">
   <td align="center" class="head"><h3>Time Card Report<br><br></td>
	</tr></table>
  <%
  ...
  String query;
   ...
   //Connection conn=null;
	...
	try
		{
			//////System.out.println("Timecardsearch3forEMPSearch.jsp::ConnectionPool----->>>>Before Open --->>>>Test");
			conn=connectionUtils.getDBConnection();
			//////System.out.println("Timecardsearch3forEMPSearch.jsp::ConnectionPool----->>>>After Open --->>>>Test");
...
<%
		...
		//////System.out.println(ex);
			...
			try
			{
				//////System.out.println("Timecardsearch3forEMPSearch.jsp::ConnectionPool--Before Close --->>>>Test");
				if (conn != null) connectionUtils.setDBClose();
				//////System.out.println("Timecardsearch3forEMPSearch.jsp::ConnectionPool--After Close--->>>>Test");
