...
String totq=request.getParameter("q");
	...
	String q1=null;
		String q2=null;
		//////System.out.println("tothrs2.jsp::ConnectionPool----->>>>Before Open --->>>>Test");
			conn=connectionUtils.getDBConnection();
			//////System.out.println("tothrs2.jsp::ConnectionPool----->>>>After Open --->>>>Test");
...
//////System.out.println("Please Give Correct Time........");
			...
			try
			{
				//////System.out.println("tothrs2.jsp::ConnectionPool--Before Close --->>>>Test");
				if (conn != null) connectionUtils.setDBClose();
				//////System.out.println("tothrs2.jsp::ConnectionPool--After Close--->>>>Test");
