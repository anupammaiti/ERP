...
<body>
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
   ...
   <td align="center" class="head"><h3>Leave Adjustment Form<br><br></td>
	</tr></table>
  <%
  ...
  String query;%>
  <input type="hidden" value="<%=name %>" id="empname"/>
  ...
  <input type="hidden" value="<%=comp %>" id="comp"/>
    <script type="text/javascript">
    	$(document).ready(function(){
    		...
    		$.get('SearchForLeaveAdjst',{empno:empno,name:name,comp:company},function(data){
    			alert('Leave Adj'+data);
    			$('#data2').html(data);
    		});
    	});
    </script>
