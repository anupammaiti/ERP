...
function goLite(BTN)
{
   window.document.frm11.elements[BTN].style.color = "#660099";
   window.document.frm11.elements[BTN].style.backgroundColor = "#FFFF99";
}

function goDim(BTN)
{
   window.document.frm11.elements[BTN].style.color = "#000066";
   window.document.frm11.elements[BTN].style.backgroundColor = "#CCFF99";
}
...
<table class="tab10" width="98%"> <tr align="center">
   <td align="center" class="head"><h3>All Employees Absent Report<br><br></td>
	</tr></table>
	<form action="absentreport" name="frm11" method="get" target="_blank" onSubmit="return datediff();">
	<table class="tab10" width="98%"><tr><td><a href="empabsent.jsp" id="anchorcolor" title="Click Here For Individual Report" ><input type="button" value="Click Here For Individual Report" name="buttabsent" id="buttonabsent" onMouseOver="goLite(this.name)"
   onMouseOut="goDim(this.name)"></a></td></tr></table>
