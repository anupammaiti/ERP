...
<table class="tab10" width="98%"> <tr align="center">
   <td align="center" class="head"><h3>Employees Attendance Report<br><br><br></td>
	</tr></table>


<table border="0" class="tab10" width="98%">
<form action="presentreport" name="frm11" method="get" target="_blank" onSubmit="return datediff();">
   <tr align="center">
    </tr>
</table>
