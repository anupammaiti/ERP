...
<table class="tab10" width="98%"> <tr align="center">
   <td align="center" class="head"><h3>Payroll Report<br><br><br><br></td>
	</tr></table>



<table border="0" bordercolor="#D468F7"   align="center" class="tab10" width="98%">
<form action="payrollserachRMdetails" name="frm11" method="post" onSubmit="return datediff();">
   <tr align="right">
   <td width="500">
  ...
  ConnectionUtils connectionUtils=new ConnectionUtils();
	  ...
	  try{
		//////System.out.println("payroll.jsp::ConnectionPool----->>>>Before Open --->>>>Test");
			conn=connectionUtils.getDBConnection();
			//////System.out.println("payroll.jsp::ConnectionPool----->>>>After Open --->>>>Test");
	//conn=cc.connection1();
  ...
  catch(SQLException se)
	{
	 ...
	 // conn.close();
			...
			try
			{
				//////System.out.println("payroll.jsp(1)::ConnectionPool--Before Close --->>>>Test");
				if (conn != null) connectionUtils.setDBClose();
				//////System.out.println("payroll.jsp(1)::ConnectionPool--After Close--->>>>Test");
   ...
   <%
	  ...
	  try{
		//////System.out.println("payroll.jsp(2)::ConnectionPool----->>>>Before Open --->>>>Test");
			conn=connectionUtils.getDBConnection();
			//////System.out.println("payroll.jsp(2)::ConnectionPool----->>>>After Open --->>>>Test");
  // conn=cc.connection1();
	Statement stmt=conn.createStatement();
  ...
  catch(SQLException se)
	{
	  se.printStackTrace();
			...
			try
			{
				//////System.out.println("payroll.jsp(2)::ConnectionPool--Before Close --->>>>Test");
				if (conn != null) connectionUtils.setDBClose();
				//////System.out.println("payroll.jsp(2)::ConnectionPool--After Close--->>>>Test");
