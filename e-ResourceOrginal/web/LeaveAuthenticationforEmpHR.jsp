...
var se1=document.frm.sess.value;
var lt1=document.frm.leavetype.value;
var odh1=document.frm.odhours.value;
if(se1=="#")
{
se1="select";
}
		//document.frmreject.action="RejectleaveBO?se="+se+"&lt="+lt+"&od="+odh+"&employeecode="+a+"&fromdate="+b+"&todate="+c+"&frommail="+e+"&tomail="+f+"&empnumbertosend="+h+"&empnametosend="+g+"&empname="+j+"&mailpassword="+pp11+"";
document.frmreject.action="RejectleaveBO?sess="+se1+"&ltype="+lt1+"&odh="+odh1+"&employeecode="+a+"&fromdate="+b+"&todate="+c+"&frommail="+e+"&tomail="+f+"&empnumbertosend="+h+"&empnametosend="+g+"&empname="+j+"";
...
<%
	...
	//////System.out.println("Enter Into JSP");
	...
	//////System.out.println("IN THE FORM...." + fdate + "............."
			+ tdate);
	
	String clpro = request.getParameter("fcl");
	//////System.out.println("clpro"+clpro);
	String slpro = request.getParameter("fsl");
	//////System.out.println("slpro"+slpro);
	String plpro = request.getParameter("fpl");
	//////System.out.println("plpro"+plpro);
	String pro = request.getParameter("pro");
	//////System.out.println("Pro"+pro);%>

	<input type="hidden" value="<%=empid%>" id="empno"/>
	<input type="hidden" value="<%=fdate %>" id="fdate"/>
	<input type="hidden" value="<%=tdate %>" id="todate"/>
  <script type="text/javascript">
  	$(document).ready(function(){
  		...
  		$.getJSON('LeaveStatus',{'empid':empno,'fdate':fdate,'todate':tdate},function(json){
  			$('.fd').val(json.fd);
  			//alert(json.fd);
  			$('.td').val(json.td);
  			//alert(json.td);
  			$('#ltype').val(json.ltype);
  			$('#stype').val(json.stype);
  			$('#odtime').val(json.odtime);
  		});
  	});
  </script>
...
<table class="tab10" width="98%" border="0"> <tr align="center">
   <td align="center" class="head"><h3>Leave Approval Form</h3><br></td>
	...
	<form action="LeaveauthenticationforempHR" method="get" name="frm" onSubmit="return checkvalid();">
...
<table border="0" bordercolor="#D468F7"   align="center" class="tab10" width="98%" >
  ...
  <td align="center">
   <table align="center"  border="0" bgcolor="#A4C6C5">
	...
	<tr>
		...
		<select name="leavetype" onMouseOver="this.className='highlight1'" onMouseOut="this.className='normal1'" class="leavetypes" id="leavetype" onChange="swap1(),swap();" >
    ...
    <option value="SPL">Special Leave</option> --%>
		...
		<td ><input type="text" name="odhours" id="odhours" onFocus="clear1();" size="6"  id="odtime" > </td>
 <td align="center"><img src="images/date.png" align="absmiddle">
  <input type="text" name="date1" id="date1" size="12" onfocus="showCalendarControl(this);" readonly="true"  class="fd">
 </td>
 <td align="center"><img src="images/date.png" align="absmiddle">
  <input type="text" name="date2" id="date2" size="12" onfocus="showCalendarControl(this);" readonly="true"  class="td">
 </td>
 <td align="center">
 ...
 <option value="SH">Second Half</option>
  ...
  <tr>
	 ...
	 <tr>
	 <td>
	  <input type="image" src="images/1.png" onClick="return datediff1();">
	 </td>
	 <td>
	   </form>
