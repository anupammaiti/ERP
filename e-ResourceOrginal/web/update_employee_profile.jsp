...
<table class="tab10" width="98%"> <tr align="center">
   ...
   ResultSet rs;
   String executequery="select * from employee where empno=?";
   try{
...
<form action="EmployeeInformationBO" method="post" name="frm" onsubmit="return create(this)">
 ...
 <tr>
<td width="226"><br><br>
<%-- <fmt:bundle basename="com.svs.resource.message">
<fmt:message key="${sql.query1}"/>
</fmt:bundle> --%>
...
<font color="#000066" size="2" face="verdana">Company name</font><font color="#FF0000">*</font>
    ...
    <td width="144">
				...
				<input name="companyname" value="<%=rs.getString("companyname")%>"/>
	 ...
	 <td><input type="text" name="empno" id="empno" onBlur="check(this);" onkeypress="return alphanumeric(event)" value="<%=rs.getString("empno")%>" readonly="true"><font color=red><div id="empno2"></div></font></td>
  </tr>
 <tr>
 ...
 <tr>
  ...
  <td>
   <input type="text" name="name" size="30" onkeypress="return alpha(event)" onBlur="return checkname();" value="<%=rs.getString("name")%>">
  ...
  <td>
      <input type="text" name="lname" onkeypress="return alpha(event)" value="<%=rs.getString("lname")%>"/>
  ...
  <td>
   <input type="text" name="fathername" size="30" onkeypress="return alpha(event)" onBlur="return checkname1();" value="<%=rs.getString("fathername")%>"/>
  </td>
  <td><font color="#000066"face="Verdana" size="2" >Date of Birth</font><font color="#FF0000">*</font>
   
  </td>
  <td>
   <input type="text" name="dob" id="dob"  onfocus="showCalendarControl(this);" value="<%=rs.getString("dob")%>" >
   <%
 ...
 <tr>
  ...
  <td>
   <input type="text" name="emailid" onblur=" return checkmail(this);" value="<%=rs.getString("emailid")%>">
  </td>
 </tr>
 ...
 <tr>
  ...
  <td>
   <input type="text" name="address" onBlur="return checkaddress();" value="<%=rs.getString("address")%>"/>
  </td>
  <td><font color="#000066"face="Verdana" size="2" >Date Of Joining</font><font color="#FF0000">*</font>
   
  </td>
  <td>
   <input type="text" name="joiningdate" value="<%=rs.getString("joiningdate")%>"  onfocus="showCalendarControl(this);">
  </td>
 </tr>
 ...
 <tr>
  ...
  <td>
  	<input type="text" name="hod" onkeypress="return alpha(event)" onBlur="return checkhod();"/>
  </td>
  <td><font color="#000066"face="Verdana" size="2" >Reporting to</font><font color="#FF0000">*</font>
    
   </td>
   <td>
    <input type="text" name="reportingto" onkeypress="return alpha(event)" onBlur="return checkrm();">
 ...
 <!-- <tr>
  ...
  <tr>
   ...
   <td>
    <input type="text" name="location" onkeypress="return alpha(event)" onBlur="return checklocation1();" value="<%=rs.getString("location")%>"/>
    </td>
   ...
   <td>
    <input type="text" name="entrymanner" value="<%=rs.getString("entrymanner")%>">
...
%>
  <td>
   <input type="text" name="moe" id="modeofemployee" value="<%=rs.getString("modeofemployement")%>"></td> 
...
<tbody id='div1' style="display: none;" class="div1">
  <tr>
   ...
   <td>
    <input type="text" name="religion" onkeypress="return alpha(event)" onBlur="return checkreligion();" value=<%=rs.getString("religion")%>/>
   </td>
  </tr>
  <tr>
   ...
   <td>
    <input type="text" name="pannumber" onkeypress="return alphanumeric(event)" value="<%=rs.getString("pannumber")%>">
   </td>
   ...
   <td>
    <input type="text" name="passportnumber" onkeypress="return alphanumeric(event)" value="<%=rs.getString("passportnumber")%>">
   </td>
  ...
  <td>
   <input type="text" name="phoneno" onkeypress="return number1(event)" onBlur="return checkphone();" value="<%=rs.getString("phoneno")%>"/>
  </td>
  <td>
    <font color="#000066"face="Verdana" size="2" >Bank A/c No</font>
   </td>
   <td>
    <input type="text" name="BankAcno" onkeypress="return number1(event)" value="<%=rs.getString("BankACNo")%>">
   </td>
  ...
  <tr>
   ...
   <td>
    <input type="text" name="presentsalary" onkeypress="return number1(event)" value="<%=rs.getString("presentsalary")%>"><font color="#FF0000" size="1">(eg. 50000)</font>
   </td>
   <td></td>
