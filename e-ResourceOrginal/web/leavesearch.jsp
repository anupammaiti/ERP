...
<table class="tab10" width="98%"> <tr align="center">
   <td align="center" class="head"><h3 align="center"> <font color="#573801" size="3" class="head"> Leave Information Mail To Employees</font></h3>
   <br><br><br><br><br><br></td>
	</tr></table>
		  
<table border="0" bordercolor="#D468F7"   align="center" class="tab10" width="98%">
<form action="empsearchformail" name="frm11" method="post" onSubmit="return datediff();">
<tr>
<td >
<table bgcolor="#A4C6C5"  border="0" width="98%">
<tr align="center"><td colspan="2"><font color="#FF0000">${leavemsg}</font></td></tr>
   <tr>
	...
	<td>
	 <font color="#006600" size="4"><strong><font color="#000066" size="2" face="Verdana">To Date</font></strong><img src="images/date.png" align="absmiddle">
	 <input type="text" name="todate" id="end" size="16" onfocus="showCalendarControl(this);" readonly="true"></font>
	 </td>

    </tr>
	<tr align="center"><td colspan="2">${msg}</td></tr>
	</table>
	</td></tr>
