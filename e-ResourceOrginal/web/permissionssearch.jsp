...
<table class="tab10" width="98%"> <tr align="center">
   <td align="center" class="head"><h3>Permissions Approval Form<br><br><br></td>
	</tr></table>
	<form action="permissions.jsp" name="frm11" method="post" >
	
<table class="tab10" width="98%">
<tr><td><br><font color="#000066" face="Verdana, Arial, Helvetica, sans-serif" size="2">>>	Please Enter ID Number Of Employee To Approve Permission</font>
	<br><br></td></tr>
