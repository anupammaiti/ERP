...
<table class="tab10" width="98%"><tr ><td>
      <a href="Employeereport" target="_blank" id="anchorcolor" title="Click Here To Generate All Employee's Details" ><input type="button" value="Click Here To Generate All Employees Report" class="butt1" onMouseOver="goLite(this.id)"
   onMouseOut="goDim(this.id)" id="allempreport"></a>
</td></tr></table>
