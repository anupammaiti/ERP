...
.ui-tpicker-grid-label {
	...
	padding: 0;
		...
		<script type="text/javascript" src="totaltime.js" />
</script>
...
function valid() {
	if (document.frminout.date.value == "") {
		alert("Please Enter Date");
		document.frminout.date.focus();
		document.frminout.date.style.background = "pink";
		return false;
	}
...
//	alert('Hello');
	...
	$.getJSON('EmployeeCardUpdate',{'sno':empno,'comp':company},function(json){
	//	alert('hai');
	var result=parseInt(json.result);
	//alert("Result is\t"+result);
	if(result===0){
		//alert('No Data Found'+result);
		$('#result1').text('Data Not Found').show().addClass('error');
		$('.swipeupdate').hide();
	}else{
		//alert('Data is');
...
<input type="hidden" value="<%=comp %>" id="comp"/>
     	 ...
     	 <tr>
        	<td width="477" align="center" valign="top" >
				...
				<jsp:include flush="true" page="hr_admin_header.jsp"></jsp:include>
								...
								<table class="tab10" width="98%">
									<tr align="center">
										<td align="center" class="head">
											<h3>
												Data Update Form(In case of FC)</h3>
												<br>
												<br>
												<br>
												<br>
								...
								<form action="reload" name="frminout" method="post"
										onSubmit="return valid();" class="swipeupdate">
								<table border="0" bordercolor="#D468F7" align="center"
									class="tab10" width="98%">
										...
										<%-- 	<%
											//////System.out.println("Card Forgotted");
													Connection con = null;
 ...
 --%>
											...
											<td>
												<input type="text" name="designation" id="desig" readonly="true">
												</font>
											</td>
										</tr>
										<tr>
											...
											<%-- <%
													...
													if (c == 0) {
																...
																out.println("</tr><table width=1000 calss='tab10'><tr  align=center bgcolor='#DEECFD'><td width=1000><font color=red face=Verdana>No Data Found For "+ empno + "</td></tr>");
																		
														
																out.println("<tr align=center  width=980 bgcolor='#DEECFD'><td><a href=inoutreload.jsp><input type=button value=back class=back></a></td></table><table class=tab10 width=980>");
													} else {
											%> --%>
											
											<td align="left">
												<font color="#006600" size="4"><strong><font
														color="#000066" size="2" face="Verdana">Date</font> </strong>&nbsp;&nbsp;&nbsp;&nbsp;
														<img src="images/date.png" align="absmiddle">
											</td>
											<td align="left">
									...
									<div class="example-container">
										<div>
											...
											<font color="#006600" size="4"><strong><font
													...
													type="text" name="first" id="time" onFocus="clear1();"
													size="10" value="HH:MM:SS"> </font>
										</div>
									...
									<div class="example-container">
										<div>
											...
											<font color="#006600" size="4"><strong><font
													...
													type="text" name="last" id="time1" onFocus="clear();"
													size="10" value="HH:MM:SS"
													onChange="return shownames(this.value,first.value);">
											</font>
										</div>
										<pre style="display: none">
	 ...
	 <%
		/*}
			...
			try
			{
				//////System.out.println("inoutreload1.jsp::ConnectionPool--Before Close --->>>>Test");
				if (con != null) connectionUtils.setDBClose();
				//////System.out.println("inoutreload1.jsp::ConnectionPool--After Close--->>>>Test");
