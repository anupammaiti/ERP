...
public class EmployeeInformationupdateDAOemp
{
	Connection con=null;
	ConnectionUtils connectionUtils=new ConnectionUtils();

	private static Logger logger = Logger.getLogger(EmployeeInformationupdateDAOemp.class.getName());
	...
	public EmployeeInformationupdateDAOemp ()
	{
		flag=false;
		flag1=false;
		flag2=false;
		...
		try
		{
			//////System.out.println("EmployeeInformationupdateDAOemp::ConnectionPool----->>>>Before Open --->>>>Test");
			con=connectionUtils.getDBConnection();
			//////System.out.println("EmployeeInformationupdateDAOemp::ConnectionPool----->>>>After Open --->>>>Test");
	...
	public String insert(Collection employee_coll)throws Exception
	{
		try
		{
			...
			if(flag)
			{
				...
				pr2.setString(36,"9999-12-31");
				pr2.setString(37,"Active");
			...
			//////System.out.println(".....Emp Details Update...Status=="+a[35]);
		...
		catch(Exception e)
		{
			...
			try
			{
				//////System.out.println("EmployeeInformationupdateDAOemp::ConnectionPool--Before Close --->>>>Test");
				if (con != null) connectionUtils.setDBClose();
				//////System.out.println("EmployeeInformationupdateDAOemp::ConnectionPool--After Close--->>>>Test");
