...
public class proratedforLeaveAutheHR extends HttpServlet
{
	static Logger logger = Logger.getLogger(proratedforLeaveAutheHR.class.getName());
...

	{
		...
		try{
			...
			//////System.out.println("proratedforLeaveAutheHR::ConnectionPool----->>>>Before Open --->>>>Test");
			con=connectionUtils.getDBConnection();
			//////System.out.println("proratedforLeaveAutheHR::ConnectionPool----->>>>After Open --->>>>Test");
			...
			//////System.out.println("CUR DATE in....Prorated......"+curdate);
			...
			while(rcmonth.next())
			{
				...
				//////System.out.println("CUR Month in....Prorated......"+curmonth);
			}
			//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			...
			//////System.out.println("ProDays in....Prorated.LeaveAuthe....."+prodays);
...
fpl=1.5;
			...
			try
			{
				//////System.out.println("proratedforLeaveAutheHR::ConnectionPool--Before Close --->>>>Test");
				if (con != null) connectionUtils.setDBClose();
				//////System.out.println("proratedforLeaveAutheHR::ConnectionPool--After Close--->>>>Test");
		...
		String username=(String)se.getAttribute("userlog");
		//////System.out.println("Username"+username);
		se.setAttribute("user_name", username);
		String password=(String)se.getAttribute("passlog");
		//////System.out.println("Password"+password);
		se.setAttribute("pwd", password);
		...
		response.sendRedirect("LeaveAuthenticationForEmployeeHR?Leave Code="+e+"&empid="+empid+"+&fcleave=1.0&fcl="+fcl+"+&fsleave=0.5&fsl="+fsl+"+&fpleave=0.0&fpl="+fpl+"&pro="+pro+"&toappyleave+&toappempcleave=1.0+&emppleave=0.0+&empsleave=0.5");
