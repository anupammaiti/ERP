...
public class SendMailRM2EMPREJECT {

	static Logger logger = Logger.getLogger(SendMailRM2EMPREJECT.class.getName());
	ConvertStackTracetoString util_stacktrace=new ConvertStackTracetoString();
	
//	private static final String SMTP_HOST_NAME = "smtp.gmail.com";"smtpout.secureserver.net";
	 ...
	 */
	public String sendmail2empreject(String emailid,String from1,String password,String sub,String body)throws Exception
	{

//////System.out.println("From id ....Final.........."+from1);
//////System.out.println("To id ....Final.........."+emailid);
fromid=from1;
...
new SendMailRM2EMPREJECT().sendSSLMessage(sendTo,emailSubjectTxt,emailMsgTxt,emailFromAddress,addressCC);//calling the mail function
