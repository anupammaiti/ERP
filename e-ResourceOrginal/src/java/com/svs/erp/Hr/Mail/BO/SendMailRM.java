...
public class SendMailRM {

	static Logger logger = Logger.getLogger(SendMailRM.class.getName());
	 ...
	 */
	public String sendmail(String emailid,String from1,String password,String sub,String body)throws Exception
	{
	...
	Calling the Mail
		...
		try
		{
			...
			new SendMailRM().sendSSLMessage(sendTo,emailSubjectTxt,emailMsgTxt,emailFromAddress,addressCC);//calling the mail function
			//////System.out.println("*******Sucessfully Mail Sent  To Reporting Manager and HR *******");
