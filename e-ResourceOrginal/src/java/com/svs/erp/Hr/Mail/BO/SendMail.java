...
import com.svs.erp.Hr.db.DatabaseConnectionPool;
...
public class SendMail {
	 ...
	 */
	public String sendmail(String empid,String empname,String emailid,String fromdate,String todate,double cl,double sl,double pl,double lop,double totalleaves,double remain,double takenleaves,double ab,String from1,String password,String sub,String body)throws Exception
	{

		//////System.out.println("SendMail:::From id ....Final.........."+from1);
		//////System.out.println("SendMail:::To id ....Final.........."+emailid);
		fromid=from1;
		password1=password;
	...
	Calling the Mail
		...
		try
		{
			...
			new SendMail().sendSSLMessage(sendTo,emailSubjectTxt,emailMsgTxt,emailFromAddress,addressCC);//calling the mail function
			//////System.out.println("SendMail:::Sucessfully Sent mail to All Employees");
		...
		catch(Exception e)
		{
			...
			s="Due to internet traffic problem, mail have not sent. Resend mail";
		}
		return s;
	}
	...
	public void sendSSLMessage(String recipients[], String subject,	String message, String from,String addressCC1[]) throws MessagingException {
		...
		//////System.out.println("SendMail:::MAIL ID IS*************"+fromid);
