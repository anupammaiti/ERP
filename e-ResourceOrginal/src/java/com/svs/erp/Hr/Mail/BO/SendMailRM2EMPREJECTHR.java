...
public class SendMailRM2EMPREJECTHR {
	
	static Logger logger = Logger.getLogger(SendMailRM2EMPREJECTHR.class.getName());
	 ...
	 */
	public String sendmail2emprejecthr(String emailid,String from1,String password,String sub,String body)throws Exception
	{
	...
	Calling the Mail
		...
		try
		{
			...
			new SendMailRM2EMPREJECTHR().sendSSLMessage(sendTo,emailSubjectTxt,emailMsgTxt,emailFromAddress,addressCC);//calling the mail function
