...
public class SendMailRM2EMPHR {

	static Logger logger = Logger.getLogger(SendMailRM2EMPHR.class.getName());
...
//private static final String SMTP_HOST_NAME = "smtp.gmail.com"; 
	 ...
	 */
	public String sendmail2empHR(String emailid,String from1,String password,String sub,String body)throws Exception
	{
...
new SendMailRM2EMPHR().sendSSLMessage(sendTo,emailSubjectTxt,emailMsgTxt,emailFromAddress,addressCC);//calling the mail function
