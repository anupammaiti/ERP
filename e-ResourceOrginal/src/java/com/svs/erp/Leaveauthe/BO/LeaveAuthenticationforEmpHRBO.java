...
import com.svs.erp.Hr.Mail.BO.SendMailRM2EMPHR;
...
public class LeaveAuthenticationforEmpHRBO extends HttpServlet
{
		...
		try
	{
		...
		SendMailRM2EMPHR sm = new SendMailRM2EMPHR();
		...
		int noofdays=1;
			...
			//////////////////////////////////////////~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			 from1=req.getParameter("frommail").trim();
					  ...
					  //////System.out.println("LeaveAuthenticationforEmpHRBO::--->>>from...."+from1+"..........tomail......"+tomailid+".....toempnum...."+empnumbertosend);
		  String password="leaveadmin123";
		...
		{
		s4=sm.sendmail2empHR(tomailid,from1,password,sub,body);
		}
		...
		//////System.out.println("LeaveAuthenticationforEmpHRBO::LEAVE TYPE Full------>>> s1........"+s1);
		log.debug("LeaveAuthenticationforEmpHRBO::Leave Type is"+s2 );
		//pw.println("<html><body><h3>"+s1+"</h3>");
		}
		//////////////////////////////////////////for half leaves......................................
		...
		s2=leavetype+" Authentication Successfully From "+date1+" to "+date2;
		log.debug("LeaveAuthenticationforEmpHRBO::Leave Type is"+s2 );
		//////System.out.println("LeaveAuthenticationforEmpHRBO::LEAVE TYPE 1/2 ----->>>>");
		...
		s3=alhrrm.approve(empid,fromdate,todate,leavetype);
		log.debug("LeaveAuthenticationforEmpHRBO::Leave Type is"+s3 );
		if(s3.equals("Approved"))
		{
		s4=sm.sendmail2empHR(tomailid,from1,password,sub,body);
		}
	...
	if(s3.equals("Approved"))
		...
		if(s1.equals(s2))
		{
		//////System.out.println("LeaveAuthenticationforEmpHRBO--->>>Check1~~~~"+s2);
		...
		//////////////////////////////////////////////////////////
		//////////////////////////////////////////////////////////
		 if(leavetype.equals("TL")) // FOR LEAVE Authentication mail and approved in status table
  		{
		//////System.out.println("LeaveAuthenticationforEmpHRBO--->>>Leave Type is 1/2 TL ~~~~~***~~~~~~");
		String fromdate=date1;
		String todate=date2;
		int cll=0;
		int sll=0;
		...
		if(s1.equals(s2))
		{
		//////System.out.println("LeaveAuthenticationforEmpHRBO--->>>Test1~~~~~"+s2);
		//~~~~~~~~~~~~~~code to approve in leavestatus and send mail
		s3=alhrrm.approve(empid,fromdate,todate,leavetype);
		log.debug("LeaveAuthenticationforEmpHRBO::Leave Type is"+s3 );
		if(s3.equals("Approved"))
		{
		//////System.out.println("LeaveAuthenticationforEmpHRBO--->>>Test 22~~~~~");
		s4=sm.sendmail2empHR(tomailid,from1,password,sub,body);
		//////System.out.println("LeaveAuthenticationforEmpHRBO--->>>Test333~~~~~");
		}
		}//equls if
		}
		...
		if(s1.equals(s2))
		{
		//////System.out.println("LeaveAuthenticationforEmpHRBO:::~~~~~~~~~~~"+s2);
		
		ladaohalf1.approve(employeecode,empname,leavetype,fromdate,todate,cll,sll,pll,lop);
		//pw.println("<html><body><h3>"+s1+"</h3>");
			//~~~~~~~~~~~~~~code to approve in leavestatus and send mail
			//////System.out.println("LeaveAuthenticationforEmpHRBO:::~~~~~~~~~~~");
		s3=alhrrm.approve(empid,fromdate,todate,leavetype);
		if(s3.equals("Approved"))
		{
		//////System.out.println("LeaveAuthenticationforEmpHRBO:::~~~~~~~~~~123~~~~~~~");
		s4=sm.sendmail2empHR(tomailid,from1,password,sub,body);
		//////System.out.println("LeaveAuthenticationforEmpHRBO:::~~~~~~~~~~456~~~~~~~");
		}
		}//equls if
		}
		/////////////////////////////////////////////////////////
