...
public class HalfLOPCLeaveDao {

	static Logger log = Logger.getLogger(HalfLOPCLeaveDao.class);
	...
	public HalfLOPCLeaveDao()
	{
		try
		{
			//////System.out.println("HalfLOPCLeaveDao::ConnectionPool----->>>>Before Open --->>>>Test");

			con=connectionUtils.getDBConnection();
			//////System.out.println("HalfLOPCLeaveDao::ConnectionPool----->>>>After Open --->>>>Test");
	...
	public void approveLOPC(String employeecode,String empname,String leavetype,String fromdate,String todate,double cll,double sll,double pll,double lop)throws SQLException,IOException
	{
		try{
			...
			if(leavetype.equals("1/2LOPC"))
			{
				for(int i=0;i<findiff;i++)
				{
					...
					//////System.out.println("HalfLOPCLeaveDao::Authenticated on the date is.....DAO3.....1/2LOPC.........."+dt);
					...
					//////System.out.println("HalfLOPCLeaveDao::TOTAL......"+totalleaves+".....CLOPEN......from leaveopen.............."+CLOPEN);
					//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Code ends here(total leaves and balance leaves from leaveopen)
					//--------------gettting balance cl if emp not there

					ttcl=CLOPEN;

					log.debug("HalfLOPCLeaveDao::Employee Id is"+emp+ "TotalLeave Is"+totalleaves+"CL From Leaveopen"+CLOPEN+"Leave Authenticated Date is"+dt );
			 ...
			 lop1=lop1;
					...
					while(r111.next())
					{
						...
						if(flagph)
						{
							...
							log.debug("HalfLOPCLeaveDao:: Data Deleted From LeaveApplications is"+ddd+"Event is "+event);
				...
				}//for~~~~~~~~FOR LOOP LOPC~~~~~~LOPC FOR LOOP END~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			}//if LOPC
			//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			///////////////////////////////////////////////////			
			//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		...
		catch(Exception ex)
		{
			...
			try
			{
				//////System.out.println("HalfLOPCLeaveDao::ConnectionPool--Before Close --->>>>Test");
				if (con != null) connectionUtils.setDBClose();
				//////System.out.println("HalfLOPCLeaveDao::ConnectionPool--After Close--->>>>Test");
