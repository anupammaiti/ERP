...
public class LeaveauthenticationSLDAO
{
	static Logger log = Logger.getLogger(LeaveauthenticationSLDAO.class);
...
String abtothrs="08:15:00";
	public LeaveauthenticationSLDAO() throws IOException,SQLException,Exception
	{
		try
		{
			//////System.out.println("LeaveauthenticationSLDAO::ConnectionPool----->>>>Before Open --->>>>Test");

			con=connectionUtils.getDBConnection();
			//////System.out.println("LeaveauthenticationSLDAO::ConnectionPool----->>>>After Open --->>>>Test");
	...
	{
	////////System.out.println("in DAO1...if ........SL..........."+leavetype);
	 try
  { 
...
//////System.out.println("date diff is"+findiff);
	///////////////////////////////////////////////////////////////////////////////////////////////NEW CODE TO AUTHENTICATE ~~~~~SL~~~~~~ only~~~~~~~~~
for(int i=0;i<findiff;i++)
	...
	/////////////////////////////////////////////////////////////////~~~~~~~~~~~~~~~CODE STARTS HERE TO AUTHENTICATION SL only~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
       if(leavetype.equals("SL"))
  {
     ...
     String s3="select empid,date,authentication from empabsent where empid=? and date=?";
		...
		////////System.out.println(" Authenticated success... if RECORD FOUND.......SL.."+leavetype+"...on"+dt);
        //}//while
		}//if
		else
		{
		s1="Authentication records are there on "+date1+" please check once";
		log.debug("LeaveauthenticationSLDAO:: Leave Type is "+s1);
