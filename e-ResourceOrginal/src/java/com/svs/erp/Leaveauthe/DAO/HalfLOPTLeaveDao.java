...
public class HalfLOPTLeaveDao {

	static Logger log = Logger.getLogger(HalfLOPTLeaveDao.class.getName());
	...
	public HalfLOPTLeaveDao()
	{
		try
		{
			//////System.out.println("HalfLOPTLeaveDao::ConnectionPool----->>>>Before Open --->>>>Test");

			con=connectionUtils.getDBConnection();
			//////System.out.println("HalfLOPTLeaveDao::ConnectionPool----->>>>After Open --->>>>Test");
	...
	public void approveLOPT(String employeecode,String empname,String leavetype,String fromdate,String todate,double cll,double sll,double pll,double lop)throws SQLException,IOException
	{
		try{
			...
			if(leavetype.equals("1/2LOPT"))
			{
				...
				for(int i=0;i<findiff;i++)
				{
					...
					//////System.out.println("HalfLOPTLeaveDao::Authenticated on the date is.....DAO3......1/2.LOPT........"+dt);
					...
					boolean flag1=false;
					boolean flag=false;
					//////System.out.println("HalfLOPTLeaveDao::EMPID. in if of LOPT.."+emp);
					...
					//////System.out.println("HalfLOPTLeaveDao::TOTAL......"+totalleaves+".....LOPT.....CLOPEN ......from leaveopen.............."+CLOPEN);
					...
					ttcl=CLOPEN;
					ttsl=SLOPEN;
					log.debug("HalfLOPTLeaveDao::Employee Id is"+emp+ "TotalLeave Is"+totalleaves+"CL From Leaveopen"+CLOPEN+"Leave Authenticated Date is"+dt );
					...
					if(flag) ///////////////////////////if emp is there..........///////////////////////////////////// if.... flag is true .. 
					{
						...
						rs=st.executeQuery("select empid,remainingleaves,grandleaves,lop1,totalcl,totalsl,totalpl,totalleaves,bcl,bsl,bpl from leaveapplications where empid='"+emp123+"'");
						rs.afterLast();
						...
						if(flag1==true)/////////////////////for getting last record of employeeeeeeeeee
						{
							...
							pl2=pl2;
							//lop1=lop3;
							totalcl=cl1;///////////////adding old CL to new CL
							totalsl=sl1;
							totalpl=pl1;
							grandleaves=grandleaves1;// adding noof leaves to grand leaves
					...
					while(r111.next())
					{
						...
						if(flagph)
						{
							...
							log.debug("HalfLOPTLeaveDao:: Data Deleted From LeaveApplications is"+ddd+"Event is "+event);
						}//flag true
					}//while
				...
				}//for~~~~~~~~FOR LOOP OF 1/2LOPT~~~~~FOR LOOP~~~~~~1/2LOPT~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			}//if PL~~~~~~~~~~~~~~~~~~~~~~
			//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		...
		catch(Exception ex)
		{
			...
			try
			{
				//////System.out.println("HalfLOPTLeaveDao::ConnectionPool--Before Close --->>>>Test");
				if (con != null) connectionUtils.setDBClose();
				//////System.out.println("HalfLOPTLeaveDao::ConnectionPool--After Close--->>>>Test");
