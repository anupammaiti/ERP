...
public class HalfTcLeaveDao {
		static Logger log = Logger.getLogger(HalfTcLeaveDao.class);
	...
	public HalfTcLeaveDao()
	{
		try
		{
			//////System.out.println("HalfTcLeaveDao::ConnectionPool----->>>>Before Open --->>>>Test");

			con=connectionUtils.getDBConnection();
			//////System.out.println("HalfTcLeaveDao::ConnectionPool----->>>>After Open --->>>>Test");
	...
	public void approvehalfTC(String employeecode,String empname,String leavetype,String fromdate,String todate,double cll,double sll,double pll,double lop)throws SQLException,IOException
	{
		try{
...
//////System.out.println("HalfTcLeaveDao::Authenticated on the date is.....DAO3.....1/2TC.........."+dt);
...
//////System.out.println("HalfTcLeaveDao::TOTAL......"+totalleaves+".....CLOPEN......from leaveopen.............."+CLOPEN);
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Code ends here(total leaves and balance leaves from leaveopen)
//--------------gettting balance cl if emp not there
			
	ttcl=CLOPEN;
				
log.debug("HalfTcLeaveDao::Employee Id is"+emp+ "TotalLeave Is"+totalleaves+"CL From Leaveopen"+CLOPEN+"Leave Authenticated Date is"+dt );
...
log.debug("HalfTcLeaveDao:: Data Deleted From LeaveApplications is"+ddd+"Event is "+event);
...
}//for~~~~~~~~FOR LOOP1/2TC~~~~~~1/2TC FOR LOOP END~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
}//if 1/2TC
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//~~~~~~~~~~~~~~~~~~~~~1/2 TS~~~~~~~~~~~~~~~~~~~~1/2 TS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~1/2 TS~~~~~~~~~~~~~~~~~
		}//try
		catch(Exception ex)
		{
			...
			try
			{
				//////System.out.println("HalfTcLeaveDao::ConnectionPool--Before Close --->>>>Test");
				if (con != null) connectionUtils.setDBClose();
				//////System.out.println("HalfTcLeaveDao::ConnectionPool--After Close--->>>>Test");
			} catch (SQLException e)
			{
				log.error("HalfTcLeaveDao:: Exception Raised", e);
