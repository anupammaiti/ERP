...
public class LeaveAuthenticationDaoTCS
{
	static Logger log = Logger.getLogger(LeaveAuthenticationDaoTCS.class.getName());
...
String abtothrs="08:15:00";
	public LeaveAuthenticationDaoTCS() throws IOException,SQLException,Exception
	{
		try
		{	
			//////System.out.println("LeaveAuthenticationDaoTCS::ConnectionPool-- --->>>>Before Open");
			con=connectionUtils.getDBConnection();
			//////System.out.println("LeaveAuthenticationDaoTCS::ConnectionPool----->>>>After Open");
	...
	{
	//////System.out.println("in DAO1....."+leavetype);
	 try
  { 
...
//////System.out.println("LeaveAuthenticationDaoTCS::-->>date diff is"+diffDays);
int  findiff=(int)diffDays+1;
//////System.out.println("LeaveAuthenticationDaoTCS::-->>date diff is"+findiff);
	...
	String dt = date1;  // Start date specify here
		...
		//////System.out.println("LeaveAuthenticationDaoTCS::-->>Authenticated on the date is...................."+dt);
	/////////////////////////////////////////////////////////////////~~~~~~~~~~~~~~~CODE STARTS HERE TO AUTHENTICATION CL,PL,TL only~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
       if(leavetype.equals("TL")||leavetype.equals("CL")||leavetype.equals("PL"))
  {
     ...
     String s3="select empid,date,authentication from empabsent where empid=? and date=?";
		...
		ps.setString(2,dt);	
			 //////System.out.println("LeaveAuthenticationDaoTCS::-->>DAO1......"+empid);
			 //////System.out.println("LeaveAuthenticationDaoTCS::-->>DAO1......"+dt);
		  rs=ps.executeQuery();
		...
		//////System.out.println("LeaveAuthenticationDaoTCS::-->> Authenticated success... if RECORD FOUND..."+leavetype+"...on"+dt);
        //}//while
		///////////////////////////////////////~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//////////////////////////////////////////////////
		...
		s1=leavetype+" Authentication Successfully From "+date1+" to "+date2;
		log.debug("LeaveAuthenticationDaoTCS ::Leave type is "+s1);
	...
	////////System.out.println("data from empabsnet Updated on ......Sunday.");
	 ...
	 catch(SQLException e)
	 {
		 ...
		 log.error(util_stacktrace.sendingErrorAsString(e)); 
					...
					try
       				 {
						//////System.out.println("LeaveAuthenticationDaoTCS::ConnectionPool--Before Close --->>>>Test");
						if (con != null) connectionUtils.setDBClose();
						//////System.out.println("LeaveAuthenticationDaoTCS::ConnectionPool--After Close--->>>>Test");
        				} catch (SQLException e)
        				{
        					log.error(util_stacktrace.sendingErrorAsString(e));
        				}
