...
public class HalfPcLeaveDao {
	static Logger log = Logger.getLogger(HalfPcLeaveDao.class);
	...
	public HalfPcLeaveDao()
	{
		try
		{
			//////System.out.println("HalfPcLeaveDao::ConnectionPool----->>>>Before Open --->>>>Test");

			con=connectionUtils.getDBConnection();
			//////System.out.println("HalfPcLeaveDao::ConnectionPool----->>>>After Open --->>>>Test");
	...
	public void approvehalfPC(String employeecode,String empname,String leavetype,String fromdate,String todate,double cll,double sll,double pll,double lop)throws SQLException,IOException
	{
		try{
		...
		String dt = fromdate;  // Start date specify here
			...
			//////System.out.println("HalfPcLeaveDao::Authenticated on the date is.....DAO3......1/2.PC........"+dt);
					...
					boolean flag1=false;
					boolean flag=false;
			//////System.out.println("HalfPcLeaveDao::EMPID. in if of PL.."+emp);
			...
			//////System.out.println("HalfPcLeaveDao::TOTAL......"+totalleaves+".....CLOPEN......from leaveopen.............."+CLOPEN+"......PLOPEN......"+PLOPEN);
			//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Code ends here(total leaves and balance leaves from leaveopen)
			//--------------gettting balance cl if emp not there
						
				ttpl=PLOPEN;
				ttcl=CLOPEN;
					log.debug("HalfPcLeaveDao::Employee Id is"+emp+ "TotalLeave Is"+totalleaves+"CL From Leaveopen"+CLOPEN+"Leave Authenticated Date is"+dt );
		  ...
		  log.debug("HalfPcLeaveDao:: Data Deleted From LeaveApplications is"+ddd+"Event is "+event);
		...
		////////System.out.println("deleted from leaveapplications  on ......Sunday.");
				...
				catch(Exception ex)
			{
					log.error(util_stacktrace.sendingErrorAsString(ex));
						...
						try
	       				 {
							//////System.out.println("HalfPcLeaveDao::ConnectionPool--Before Close --->>>>Test");
							if (con != null) connectionUtils.setDBClose();
							//////System.out.println("HalfPcLeaveDao::ConnectionPool--After Close--->>>>Test");
