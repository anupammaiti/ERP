...
public class HalfLOPPLeaveDao {
		static Logger log = Logger.getLogger(HalfLOPPLeaveDao.class);
	...
	public HalfLOPPLeaveDao()
	{
		try
		{
			//////System.out.println("HalfLOPPLeaveDao::ConnectionPool----->>>>Before Open --->>>>Test");

			con=connectionUtils.getDBConnection();
			//////System.out.println("HalfLOPPLeaveDao::ConnectionPool----->>>>After Open --->>>>Test");
	...
	public void approveLOPP(String employeecode,String empname,String leavetype,String fromdate,String todate,double cll,double sll,double pll,double lop)throws SQLException,IOException
	{
		try{
			...
			if(leavetype.equals("1/2LOPP"))
			{
				...
				for(int i=0;i<findiff;i++)
				{
					...
					//////System.out.println("HalfLOPPLeaveDao::Authenticated on the date is.....DAO3.......1/2LOPP........"+dt);
					...
					//////System.out.println("HalfLOPPLeaveDao::TOTAL......"+totalleaves+".....CL......from leaveopen.............."+CLOPEN);
					//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Code ends here(total leaves and balance leaves from leaveopen)
					//--------------gettting balance cl if emp not there

					ttpl=PLOPEN;

					log.debug("HalfLOPPLeaveDao::Employee Id is"+emp+ "TotalLeave Is"+totalleaves+"CL From Leaveopen"+CLOPEN+"Leave Authenticated Date is"+dt );
					...
					while(r111.next())
					{
						...
						if(flagph)
						{
							...
							log.debug("HalfLOPPLeaveDao:: Data Deleted From LeaveApplications is"+ddd+"Event is "+event);
						}//flag true
					}//while
		...
		catch(Exception ex)
		{
			...
			try
			{
				//////System.out.println("HalfLOPPLeaveDao::ConnectionPool--Before Close --->>>>Test");
				if (con != null) connectionUtils.setDBClose();
				//////System.out.println("HalfLOPPLeaveDao::ConnectionPool--After Close--->>>>Test");
