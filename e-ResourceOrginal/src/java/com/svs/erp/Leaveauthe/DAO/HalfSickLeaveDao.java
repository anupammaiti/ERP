...
public class HalfSickLeaveDao {

	static Logger log = Logger.getLogger(HalfSickLeaveDao.class);
	...
	public HalfSickLeaveDao()
	{
		try
		{
			//////System.out.println("HalfSickLeaveDao::ConnectionPool----->>>>Before Open --->>>>Test");

			con=connectionUtils.getDBConnection();
			//////System.out.println("HalfSickLeaveDao::ConnectionPool----->>>>After Open --->>>>Test");
		}catch(Exception ex)
		{
	...
	public void approvehalfSL(String employeecode,String empname,String leavetype,String fromdate,String todate,double cll,double sll,double pll,double lop)throws SQLException,IOException
	{
		try{
			...
			if(leavetype.equals("1/2SL"))
			{
				...
				for(int i=0;i<findiff;i++)
				{
					...
					//////System.out.println("HalfSickLeaveDao::Authenticated on the date is.....DAO3.......1/2SL........"+dt);
					
					//////System.out.println("HalfSickLeaveDao::Checking is ok HALF******************SL");
					...
					boolean flag1=false;
					boolean flag=false;
					////////System.out.println("EMPID. in if of SL.."+emp);
					//~~~~~~~~~~~~~~~~~~~~~~~~~V.IMP~~~~~~~~~~getting total leaves and balance leaves from leaveopen.........
					//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
					PreparedStatement  plo2=con.prepareStatement("select TOTAL,CLBAL,CLOPEN,SLOPEN,PLOPEN from leaveopen where empid=?");
					plo2.setString(1,emp);
					ResultSet rlo2=plo2.executeQuery();
					while(rlo2.next())
					{
						totalleaves=rlo2.getDouble(1);
						CLBAL=rlo2.getDouble(2);
						CLOPEN=rlo2.getDouble(3);
						SLOPEN=rlo2.getDouble(4);
						PLOPEN=rlo2.getDouble(5);
					}
					//////System.out.println("HalfSickLeaveDao::TOTAL......"+totalleaves+".....SL..........."+SLOPEN);
					//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Code ends here(total leaves and balance leaves from leaveopen)
					///////----------------------------------------------//--------------gettting balance SL  if emp not there
					log.debug("HalfSickLeaveDao:: Employee Id is "+emp+"Authenticated On the Date is"+dt+"Total Leaves "+totalleaves+"CL Open "+CLOPEN);

					ttsl=SLOPEN;
					////////System.out.println("....................empnot there.................Total SL...after  dividing............TTSL..............."+ttsl);

					bsl=ttsl-sl2;
					////////System.out.println("....................empnot there.................Total SL...after deduct.......BSL...................."+bsl);
					...
					while(rs1.next())
					{
						...
						emp123=emp;
						////////System.out.println("EMPID...........if empid is there......SL....."+emp123);
						...
						//	//////System.out.println(" Emp ID.........If ...there........SL...... "+ emp123);
						if(emp.equals(emp123))
						{
							flag=true;
							////////System.out.println("EMP eqals.......in ....SL.........Flag ");
					...
					PreparedStatement prdecre1=con.prepareStatement("update leaveopen set SLBAL=(SLBAL-0.5) where empid='"+emp+"'");
					prdecre1.executeUpdate();

				} //~~~~~~~~~~~~~~~~~~~FOR LOOP ~~~~~~1/2SL~~~~~~~~~~~~~~~~~~~~~ second  SL FOR LOOP close
			}//if SL
			////////////////////////////////////////////////////////////       if PL........1/2PL~~~~~~1/2PL~~~~~~~~~~1/2PL~~~~~~~~~~~~1/2PL~~~~~~~~~.............
		...
		catch(Exception ex)
		{
			...
			try
			{
				//////System.out.println("HalfSickLeaveDao::ConnectionPool--Before Close --->>>>Test");
				if (con != null) connectionUtils.setDBClose();
				//////System.out.println("HalfSickLeaveDao::ConnectionPool--After Close--->>>>Test");
