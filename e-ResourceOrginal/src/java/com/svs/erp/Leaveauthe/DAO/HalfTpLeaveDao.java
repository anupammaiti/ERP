...
public class HalfTpLeaveDao {
		static Logger log = Logger.getLogger(HalfTpLeaveDao.class);
	...
	public HalfTpLeaveDao()
	{
		try
		{
			//////System.out.println("HalfTpLeaveDao::ConnectionPool----->>>>Before Open --->>>>Test");

			con=connectionUtils.getDBConnection();
			//////System.out.println("HalfTpLeaveDao::ConnectionPool----->>>>After Open --->>>>Test");
	...
	public void approvehalfTP(String employeecode,String empname,String leavetype,String fromdate,String todate,double cll,double sll,double pll,double lop)throws SQLException,IOException
	{
		try{
		...
		String dt = fromdate;  // Start date specify here
			...
			//////System.out.println("HalfTpLeaveDao::Authenticated on the date is.....DAO3.......1/2TP........"+dt);
			...
			//////System.out.println("HalfTpLeaveDao::TOTAL......"+totalleaves+".....PLOPEN......from leaveopen.............."+PLOPEN);
			...
			//--------------gettting balance cl if emp not there
				...
				ttpl=PLOPEN;
					...
					log.debug("HalfTpLeaveDao::Employee Id is"+emp+ "TotalLeave Is"+totalleaves+"CL From Leaveopen"+CLOPEN+"Leave Authenticated Date is"+dt );
		  ...
		  while(r111.next())
		   ...
		   log.debug("HalfTpLeaveDao:: Data Deleted From LeaveApplications is"+ddd+"Event is "+event);
	...
	/////////////////////////////////////////////////////////////////////////////////////////
		...
		////////System.out.println("deleted from leaveapplications  on ......Sunday.");
			}//for~~~~~~~~FOR LOOP OF 1/2TP~~~~~FOR LOOP~~~~~~1/2TP~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			}//if 1/2TP~~~~~~~~~~~~~~~~~~~~~~
			//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~


			////////////////////////////////////////////////////////////       if 1/2PC........1/2PC~~~~~~1/2PC~~~~~~~~~~1/2PC~~~~~~~~~~~~1/2PC~~~~~~~~~.............
		}//try
		catch(Exception ex)
		{
			log.error(util_stacktrace.sendingErrorAsString(ex));
			...
			try
			{
				//////System.out.println("HalfTpLeaveDao::ConnectionPool--Before Close --->>>>Test");
				if (con != null) connectionUtils.setDBClose();
				//////System.out.println("HalfTpLeaveDao::ConnectionPool--After Close--->>>>Test");
