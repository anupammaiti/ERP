...
public class LeaveAdjustmentDaoImpl
{
	static Logger log = Logger.getLogger(LeaveAdjustmentDaoImpl.class);
...
String abtothrs="08:15:00";
	public LeaveAdjustmentDaoImpl() throws IOException,SQLException,Exception
	{
		try
		{
			//////System.out.println("LeaveAdjustmentDaoImpl::ConnectionPool----->>>>Before Open --->>>>Test");

			con=connectionUtils.getDBConnection();
			//////System.out.println("LeaveAdjustmentDaoImpl::ConnectionPool----->>>>After Open --->>>>Test");
	...
	{
	//////System.out.println("LeaveAdjustmentDaoImpl::in DAO1....."+leavetype);
	 try
  { 
...
//////System.out.println("LeaveAdjustmentDaoImpl::date diff is"+diffDays);
int  findiff=(int)diffDays+1;
//////System.out.println("LeaveAdjustmentDaoImpl::date diff is"+findiff);
	...
	String dt = date1;  // Start date specify here
		...
		//////System.out.println("LeaveAdjustmentDaoImpl::Authenticated on the date is...................."+dt);
	/////////////////////////////////////////////////////////////////~~~~~~~~~~~~~~~CODE STARTS HERE TO AUTHENTICATION 1/2CS,1/2PT,1/2TS..... only~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
       if(leavetype.equals("1/2CS")||leavetype.equals("1/2SP")||leavetype.equals("1/2PC")||leavetype.equals("1/2TC")||leavetype.equals("1/2TS")||leavetype.equals("1/2TP"))
  {
     ...
     String s3="select empid,date,authentication from empabsent where empid=? and date=?";
		...
		//////System.out.println(" LeaveAdjustmentDaoImpl::Authenticated success. from leave adjustment.. if RECORD FOUND..."+leavetype+"...on"+dt);
        //}//while
		
		log.debug("LeaveAdjustmentDaoImpl::"+leavetype+"Authentication Successfully From "+date1+" to "+date2+"From Leave Adjustment.. if RECORD FOUND On"+dt);
		///////////////////////////////////////~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//////////////////////////////////////////////////
		...
		log.debug("LeaveAdjustmentDaoImpl::Leave Type Is"+s1);
	...
	////////System.out.println("data from empabsnet Updated on ......Sunday.");
	 ...
	 catch(SQLException e)
	 {
		 ...
		 log.error(util_stacktrace.sendingErrorAsString(e)); 
					...
					try
       				 {
						//////System.out.println("LeaveAdjustmentDaoImpl::ConnectionPool--Before Close --->>>>Test");
						if (con != null) connectionUtils.setDBClose();
						//////System.out.println("LeaveAdjustmentDaoImpl::ConnectionPool--After Close--->>>>Test");
        				} catch (SQLException e)
        				{
        					log.error(util_stacktrace.sendingErrorAsString(e));
        				}
