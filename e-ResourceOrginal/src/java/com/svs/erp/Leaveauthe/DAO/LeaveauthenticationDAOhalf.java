...
public class LeaveauthenticationDAOhalf
{
	static Logger log = Logger.getLogger(LeaveauthenticationDAOhalf.class);
...
String abtothrs="04:00:00";
	public LeaveauthenticationDAOhalf() throws IOException,SQLException,Exception
	{
		try
		{
			//////System.out.println("LeaveauthenticationDAOhalf::ConnectionPool----->>>>Before Open --->>>>Test");

			con=connectionUtils.getDBConnection();
			//////System.out.println("LeaveauthenticationDAOhalf::ConnectionPool----->>>>After Open --->>>>Test");
...
//////System.out.println("date diff is"+findiff);
	...
	/////////////////////////////////////////////////////////////////~~~~~~~~~~~~~~~CODE STARTS HERE TO AUTHENTICATION 1/2CL,1/2PL,1/2TL only~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
       if(leavetype.equals("1/2TL")||leavetype.equals("1/2CL")||leavetype.equals("1/2PL")||leavetype.equals("1/2SL"))
  {
   
     String s3="select empid,date,leavetype from empinout1 where empid=? and date=? ";//and tothrs<='06:00:00'";
		PreparedStatement ps=null;
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//////////////////////////////////////////////////
		...
		log.debug("LeaveauthenticationDAOhalf::::Authenticated success....If RECORD NOT FOUND.."+leavetype+"...on"+dt+".........sesssion...."+sess);
		...
		///////////////////////////////////////////////
		s1=leavetype+" Authentication Successfully From "+date1+" to "+date2;
		log.debug("LeaveauthenticationDAOhalf::Leavetype is "+s1);
		}
		else
		{
		s1="No records on. "+dt;
	...
	////////System.out.println("data from empabsnet Updated on ......Sunday.");
	 ...
	 catch(SQLException e)
	 {
		 ...
		 log.error(util_stacktrace.sendingErrorAsString(e)); 
					...
					try
       				 {
						//////System.out.println("LeaveauthenticationDAOhalf::ConnectionPool--Before Close --->>>>Test");
						if (con != null) connectionUtils.setDBClose();
						//////System.out.println("LeaveauthenticationDAOhalf::ConnectionPool--After Close--->>>>Test");
