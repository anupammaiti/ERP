...
public class HalfTsLeaveDao {
static Logger log = Logger.getLogger(HalfTsLeaveDao.class.getName());
ConvertStackTracetoString util_stacktrace=new ConvertStackTracetoString();
	...
	public HalfTsLeaveDao()
	{
		try
		{
			//////System.out.println("HalfTsLeaveDao::ConnectionPool----->>>>Before Open --->>>>Test");

			con=connectionUtils.getDBConnection();
			//////System.out.println("HalfTsLeaveDao::ConnectionPool----->>>>After Open --->>>>Test");
	...
	public void approvehalfTS(String employeecode,String empname,String leavetype,String fromdate,String todate,double cll,double sll,double pll,double lop)throws SQLException,IOException
	{
		try{
			...
			if(leavetype.equals("1/2TS"))
			{
				...
				for(int i=0;i<findiff;i++)
				{
					...
					//////System.out.println("HalfTsLeaveDao::Authenticated on the date is.....DAO3.......1/2TS........"+dt);
					...
					//////System.out.println("HalfTsLeaveDao::TOTAL......"+totalleaves+".....SLOPEN......from leaveopen.............."+SLOPEN);
					//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Code ends here(total leaves and balance leaves from leaveopen)
					///////-------------------------------------------------------------------------------------//--------------gettting balance SL  if emp not there

					ttsl=SLOPEN;
					log.debug("HalfTsLeaveDao::Employee Id is"+emp+ "TotalLeave Is"+totalleaves+"CL From Leaveopen"+SLOPEN+"Leave Authenticated Date is"+dt );
				...
				} //~~~~~~~~~~~~~~~~~~~FOR LOOP ~~~~~~1/2TS~~~~~~~~~~~~~~~~~~~~~ second  1/2TS FOR LOOP close
			}//if 1/2 TS
			////////////////////////////////////////////////////////////       if 1/2TP........1/2TP~~~~~~1/2TP~~~~~~~~~~1/2TP~~~~~~~~~~~~1/2TP~~~~~~~~~.............
		...
		catch(Exception ex)
		{
			...
			try
			{
				//////System.out.println("HalfTsLeaveDao::ConnectionPool--Before Close --->>>>Test");
				if (con != null) connectionUtils.setDBClose();
				//////System.out.println("HalfTsLeaveDao::ConnectionPool--After Close--->>>>Test");
