...
/**
 * Servlet implementation class AttendencePageReload
 */
public class AttendencePageReload extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		////////System.out.println("hi...........test"+ss);
			...
			String datedel=request.getParameter("fromdate");
			String contentType = request.getContentType();
			//////System.out.println("hi...........1"+contentType);
				//////System.out.println("hi...........date to delete.................."+datedel);
		...
		////////System.out.println("hi..........8........"+boundary);
				...
				String reload=prop.getProperty("attendence.reload");
				// creating a new file with the same name and writing the content in new file
				FileOutputStream fileOut = new FileOutputStream(reload+""+saveFile);
		...
		//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
				...
				session.setAttribute("sheetnamereload",saveFile);
				session.setAttribute("datedel",datedel);
				response.sendRedirect("loadtomysqlinout11");
				}
