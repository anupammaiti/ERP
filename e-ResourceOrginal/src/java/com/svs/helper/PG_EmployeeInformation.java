...
/**
 * Servlet implementation class PG_EmployeeInformation
 */
public class PG_EmployeeInformation extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher view = request.getRequestDispatcher("employeeinformationform1details");
