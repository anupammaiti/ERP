...
/**
 * Servlet implementation class PaidDaysList
 */
public class PaidDaysList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			pr=con.prepareStatement("SELECT * FROM payrollhr where empid=?");
			pr.setString(1,request.getParameter("empid"));
			rs=pr.executeQuery();
			while(rs.next()){
