...
/**
 * Servlet implementation class LoanAuthentication
 */
public class LoanAuthentication extends HttpServlet {
	...
	try{
        ...
        LoanDAO empdao = new LoanDAO();
        String companyname=(String)request.getSession().getAttribute("comp");
        List<LoanFormBean> list = empdao.displayLoanAuthentication((page-1)*recordsPerPage,recordsPerPage,companyname);
        ...
        RequestDispatcher view = request.getRequestDispatcher("loan_authentication.jsp");
