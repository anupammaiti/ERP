...
/**
 * Servlet implementation class PG_PaySlipList
 */
public class PG_PaySlipList extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher view = request.getRequestDispatcher("employee_details_for_payslip.jsp");
