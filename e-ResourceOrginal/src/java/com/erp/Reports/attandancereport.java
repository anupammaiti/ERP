...
public class attandancereport extends HttpServlet
{
	...
	final static Logger logger = Logger.getLogger(attandancereport.class);
...
String empno=request.getParameter("empno");
		...
		try {
			...
			InputStream reportStream = servletContext.getResourceAsStream("/Reports/attandancereport.jasper");
