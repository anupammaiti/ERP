...
public class latecoming extends HttpServlet
{
	
	private ServletContext servletContext;
	final static Logger logger = Logger.getLogger(latecoming.class);
...
String empno=request.getParameter("empno");
		...
		try {
			...
			InputStream reportStream = servletContext.getResourceAsStream("/Reports/latecoming.jasper");
