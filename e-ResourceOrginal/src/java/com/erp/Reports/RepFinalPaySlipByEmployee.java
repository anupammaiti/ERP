...
/**
 * Servlet implementation class RepFinalPaySlipByEmployee
 */
public class RepFinalPaySlipByEmployee extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private ConnectionUtils connection1=new ConnectionUtils();
	private ServletContext servletContext;
	final static Logger logger = Logger.getLogger(RepFinalPaySlipByEmployee.class);
		...
		// TODO Auto-generated method stub
		 String fromdate=request.getParameter("fromdate");
			...
			try {
				...
				InputStream reportStream = servletContext.getResourceAsStream("/Reports/rep_finalpayslip.jasper");
			
				
			
				con=connection1.getDBConnection();
				HashMap hm = new HashMap();
				//Map reportParameters = new HashMap();
				    hm.put("empid",request.getParameter("id"));
