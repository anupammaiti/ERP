...
public class EarlyGoing extends HttpServlet
{
	
	private ServletContext servletContext;
	final static Logger logger = Logger.getLogger(EarlyGoing.class);
...
//String empno=request.getParameter("empno");
		...
		try {
			...
			InputStream reportStream = servletContext.getResourceAsStream("/Reports/EarlyGoing.jasper");
