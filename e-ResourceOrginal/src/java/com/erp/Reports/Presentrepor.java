...
public class Presentrepor extends HttpServlet
{
	
	private ServletContext servletContext;
	final static Logger logger = Logger.getLogger(Presentrepor.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try {
			...
			InputStream reportStream = servletContext.getResourceAsStream("/Reports/presentreport.jasper");
