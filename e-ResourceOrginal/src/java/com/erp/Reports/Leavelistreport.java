...
public class Leavelistreport extends HttpServlet
{
	
	private ServletContext servletContext;
	final static Logger logger = Logger.getLogger(Leavelistreport.class);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try {
			...
			InputStream reportStream = servletContext.getResourceAsStream("/Reports/leavelistreport.jasper");
