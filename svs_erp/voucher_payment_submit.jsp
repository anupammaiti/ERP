...
<p>&nbsp;</p>
 ...
 <%
	...
	String q1="insert into voucher_payment (v_date,vouchertype,account,particulars,amount,narration)	values ('"+d1+"','Payment' , '"+s1+"','"+s2+"',"+s3+" ,'"+s4+"')";
...
String sq2= "select balance from current_assets where ledgername='"+s2+"' ";
	...
	{
		String iq1="insert into current_assets values('"+s2+"', "+d+" , '"+und2+"' )";
		int ii2=st.executeUpdate(iq1);
	}
