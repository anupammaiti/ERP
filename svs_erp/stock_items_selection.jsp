...
<table align="center"    >
<tr>
 <td ><strong> <font color="#573801" size="3"  face = "verdana">Stock Items  Selection</font></strong>
</td>
</tr>
</table>
...
<form action="stock_items_display.jsp" method="post">

<table  border = "1"    align="center"  width="800"  bgcolor="#FADFC3" bordercolor="#F0B269"  ><tr>
<td width="392">
<font color="#573801" face="verdana" size="2">Select The Stock Item  :</font>
</td>

<td width="392">
<% 
	Statement stmt=con.createStatement();
	 String s="select * from stockitems";
