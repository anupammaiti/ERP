...
<% 
   ...
   String str="insert into vocherdata values(?,?,?,?,?,?,?,?,?)";
   PreparedStatement pstmt=conn.prepareStatement(str);
   pstmt.setString(1,request.getParameter("vochername"));
  
   pstmt.setString(2,request.getParameter("vochertype"));
   pstmt.setString(3,request.getParameter("abbr"));
   pstmt.setString(4,request.getParameter("vochernumbering"));
   pstmt.setString(5,request.getParameter("advconfiguration"));
   pstmt.setString(6,request.getParameter("useeffectivedates"));
   pstmt.setString(7,request.getParameter("usecommonnarration"));
   
   pstmt.setString(8,request.getParameter("narrationsforeachentry"));
   pstmt.setString(9,request.getParameter("nameofclass"));
