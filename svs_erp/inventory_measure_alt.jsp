...
<table align="center"    >
<tr>
 <td ><strong> <font color="#573801" size="3" face="verdana">Types of Measure  Details</font></strong>
</td>
</tr>
</table>
...
<form action="inventory_measure_alt_select.jsp" method="post">
...
<form action="dummy_measure_alt.jsp" method = "post" >


<% 
	String ser=request.getParameter("measure");
	Statement st2=con.createStatement();
	 String q2="select * from unitsofmeasure where symbol=? ";
...
<td>
<input type="text" name="symbol" size="15" value=<%out.println(ss2);%> > 
</td>
</tr>
...
<td>
<input type="text" name="formalnm" size="15" value=<%out.println(ss3);%> >
</td>
</tr>
...
<td>
<input type="text" name="numofdec" size="15" value=<%out.println(ss4);%> >
</td>
</tr>
