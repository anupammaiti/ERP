...
<h4 align="center"><font color="#573801" face="verdana" size="3"> Purchases Vouchers </font></h4>
<table align="center" width="800" border="1" bgcolor="#FADFC3" bordercolor="#F0B269">
  <form action="fn_accountingvoucher_purchase_submit.jsp">
    <tr>
      <td width="392" align="right"><font color="#573801" face="verdana" size="2"> No. </font> </td>
      <td width="392" colspan="2"><%
     int count=0;
	 int count1=0;
	 String str="select * from fn_accvoucher_purchase";
   ...
   %>
    ...
    <tr>
      <td align="right"><font color="#573801" face="verdana" size="2"> Purchase Ledger </font> </td>
      <td><%
	...
	while(rs1.next())
	  ...
	  if(rs1.getString(3).equalsIgnoreCase("purchaseaccounts"))
	  {
	   out.println("<option>");
