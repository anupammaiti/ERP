...
<h4 align="center"><font color="#573801" face="verdana" size="3"> Contra Voucher </font></h4>
   ...
   <%
	...
	pstmt2.executeUpdate();
     ...
     String str="insert into fn_accvoucher_contra (date1,account,particulars,amount,narration,id) values(?,?,?,?,?,?)";
    ...
    pstmt.executeUpdate();
	 ...
	 // out.println(rs.getString(2));
	  ...
	  if(rs.getString(1).equals(request.getParameter("accountfrom")))
	  {
