...
<% } %>
 ...
 <table align="center"    >
   <tr>
     <td ><strong> <font  face = "verdana"  size = "3"  color="#573801" >Sales Returns Details</font></strong> </td>
   </tr>
 </table>
 <p>&nbsp;</p>
 ...
 <table align="center" width="1000" border="1"  bgcolor="#FADFC3" bordercolor="#F0B269">
	...
	<% 
		double tot = 0.0;
		String ps="select * from sl_sales_returns";
	...
	<tr>
		...
		<td align="center"> <% out.println(prs.getString(11));%></td>
		<td align="center"> <% out.println(prs.getString(12));%></td>
