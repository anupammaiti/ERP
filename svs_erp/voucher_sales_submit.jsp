...
<p>&nbsp;</p>
 ...
 <%
	...
	String q1="insert into voucher_sales (refno,v_date,vouchertype,partyaccname,salesledger,nameofitem,quantity,rate,units,amount,narration) values('"+s1+"','"+dt1+"','Sales','"+s2+"','"+s3+"','"+s4+"',"+ii+","+d1+",'"+s7+"',"+d2+",'"+s9+"')";
