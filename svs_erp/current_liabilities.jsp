...
<input align ="right" type="image" src="images/back.jpg"/>
 ...
 <table align="center"    >
   <tr>
     <td ><strong> <font  face = "verdana" size = "3" color="#573801" >Current Liabilities Details</font></strong> </td>
   </tr>
 </table>
 <p>&nbsp;</p>
 ...
 <table align="center" width="800" border="1"  bgcolor="#FADFC3" bordercolor="#F0B269">
	...
	<% 
		double tot=0;
		String cs="select ledgername,balance from current_assets where  under='SundryCreditors' ";
	...
	<form action="#" >
	<tr>
		<td align="center"> <% out.println(crs.getString(1));%></td>
		<td align="center"> <% out.println("");%></td>
		<td align="right"> <% out.println(-crs.getDouble(2));%></td>
