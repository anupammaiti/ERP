...
<%
 ...
 String str="insert into misc_Expenses values(?,?,?,?,?,?,?,?,?)";
 ...
 pstmt.setString(1,request.getParameter("employeename"));
  ...
  pstmt.setString(6,request.getParameter("purpose"));
  pstmt.setString(7,request.getParameter("amount"));
   ...
   <td>
    <table align="center" width="800" border="1" bgcolor="#FADFC3" bordercolor="#F0B269">
	 <tr>
	  ...
	  <td width="258">
	   <font color="#573801" face="verdana" size="2"><strong>Purpose</strong></font>
	  </td>
	 ...
	 <tr>
	  <td>
	   ...
	   <td>
	    <font color="#573801" face="verdana" size="2">
	    <%out.println(request.getParameter("purpose"));%>
	    </font>	   </td>
