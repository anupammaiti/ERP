...
<h4 align="center"><font color="#573801" face="verdana" size="3">Entertainment Expenses</font></h4>
<%
 Class.forName("com.mysql.jdbc.Driver");
 Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/kvk","root","root");
 String str="insert into enter_Expenses values(?,?,?,?,?,?,?,?)";
 ...
 pstmt.setString(1,request.getParameter("employeename"));
  ...
  pstmt.setString(6,request.getParameter("amountdue"));
