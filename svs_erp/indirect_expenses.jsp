...
<input align ="right" type="image" src="images/back.jpg"/>
 ...
 <table align="center"    >
   <tr>
     <td ><strong> <font  face = "verdana" size = "3" color="#573801">Indirect Expenses Details</font></strong> </td>
   </tr>
 </table>
 <p>&nbsp;</p>
 ...
 <table align="center" width="800" border="1"  bgcolor="#FADFC3" bordercolor="#F0B269">
	...
	<% 
		...
		String ps="select v.* from voucher_payment v ,ledgersdata where ledgername=v.particulars and under='IndirectExpenses' ";
		...
		i++;
	%>
	<form action="indirect_expenses_alter.jsp" >
	<tr>
	...
	<% 
		...
		String pjs="select vj.* from voucher_journal vj ,ledgersdata where ledgername=vj.by_parti and under='IndirectExpenses' ";
