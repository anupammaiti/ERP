...
<input align ="left" type="image" src="images/home.jpg"/>
 ...
 <table align="center"    >
<tr>
 <td ><strong> <font  face = "verdana" size = "3" color="#573801" >Accounting Voucher Details</font></strong>
</td>
</tr>
...
<form action="voucher_receipt.jsp" method="post">
<tr>
<td >
<input type="submit"   name="voucher" value="         Receipt          " />
</td>
</tr>
</form>
...
<form action="voucher_contra.jsp" method="post">
<tr>
<td >
<input type="submit" name="group"   width="200"value="           Contra           " />
</td>
</tr>
</form>
<tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>
<form action="voucher_payment.jsp" method="post">
<tr>
<td >
<input type="submit" name="group" value="         Payment        " />
</td>
</tr>
</form>
...
<tr>
<td >
<input type="submit"   name="voucher" value="           Journal         " />
</td>
</tr>
</form>
...
<tr>
<td >
<input type="submit"   name="voucher" value="          Purchase      " />
</td>
</tr>
</form>

<tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>
<form action="voucher_sales.jsp" method="post">
<tr>
<td >
...
<tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>
<form action="voucher_purchase_return.jsp" method="post">
<tr>
<td >
<input type="submit"   name="voucher" value="Purchase Returns" />
</td>
</tr>
</form>
