...
<input align ="left" type="image" src="images/home.jpg"/>
 ...
 <table align="center"    >
<tr>
 <td ><strong> <font  face = "verdana" size = "3"  color="#573801" >Sales Accounts Alter</font></strong>
</td>
</tr>
...
//out.println("a :   "+a);
String s= "select * from voucher_sales where no="+a+" ";
...
<form action="sales_accounts.jsp" method="post">
<tr>
<td width="1100"/>
