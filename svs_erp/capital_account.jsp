...
<input align ="right" type="image" src="images/back.jpg"/>
 ...
 <table align="center"    >
   <tr>
     <td ><strong> <font  face = "verdana" size = "3" color="#573801" >Capital Account Details</font></strong> </td>
   </tr>
 </table>
 <p>&nbsp;</p>
 ...
 <table align="center" width="800" border="1"  bgcolor="#FADFC3" bordercolor="#F0B269">
	...
	<% double tot = 0;
		String ps="select l.ledgername,c.balance from current_assets c,ledgersdata l where (l.ledgername=c.ledgername and l.under='CapitalAccount') ";
 ...
 <table align="center" width="800" border="1"  bgcolor="#FADFC3" bordercolor="#F0B269">
 	<tr>
		<td  align="center"> <strong><font   face="Times New Roman, Times, serif">Total</font></strong></td>
		<td  width="300"align="center"> <% out.println(tot);%> </td>
		<td width="180" align="center"> <% out.println("");%> </td>
