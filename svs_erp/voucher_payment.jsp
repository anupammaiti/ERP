...
<input align ="right" type="image" src="images/back.jpg"/>
 ...
 <table align="center"    >
<tr>
 <td ><strong> <font  face = "verdana" size = "3" color="#573801" >Payment Details</font></strong>
</td>
</tr>
...
<table align="center" width="800" border="1" bgcolor="#FADFC3" bordercolor="#F0B269">
 ...
 <form action="voucher_payment_submit.jsp"  name="form1" onSubmit="return validations();">
 <tr>
  <td width="392">
  ...
  <%
	  ...
	  String str2="select no from voucher_payment ";
