...
<input align ="right" type="image" src="images/back.jpg"/>
 ...
 <table align="center"    >
   <tr>
     <td ><strong> <font  face = "verdana" size = "3" color="#573801" >Current Assets Details</font></strong> </td>
   </tr>
 </table>
 <p>&nbsp;</p>
 ...
 <table align="center" width="800" border="1"  bgcolor="#FADFC3" bordercolor="#F0B269">
	...
	%>
	<form action="closing_stock.jsp" >
	<tr>
		<td align="center"> <% out.println("Closing Stock");%></td>
		<td align="right"> <% out.println(crs.getDouble(1));%></td>
		<td width="50" align="center"> <input type="submit" name="submit" value="Display" ></td>
		<input type="hidden" name="hid1" value=<% out.println("cl");%> > 
	</tr>
	</form>
	<% 
		
		
		tot = tot + crs.getDouble(1);
		}
	...
	<% 
		//String ps="select l.under,c.balance from current_assets c,ledgersdata l where (l.ledgername=c.ledgername and l.under='BankAccounts') | (l.ledgername=c.ledgername and  l.under='Cash-in-hand' ) ";
		
		String ps="select under,balance from current_assets  where ( under='BankAccounts') | ( under='Cash-in-hand' ) | ( under='SundryDebtors' ) | (  under='CurrentAssets' )";
		...
		i++;
	%>
	<form action="current_assets_detailed.jsp" >
	<tr>
