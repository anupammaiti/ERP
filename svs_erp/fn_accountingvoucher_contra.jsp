...
<h4 align="center"><font color="#573801" face="verdana" size="3"> Contra Voucher </font></h4>
<table align="center" width="800" border="1" bgcolor="#FADFC3" bordercolor="#F0B269">
 <form action="fn_accountingvoucher_contrasubmit.jsp" method="post">
 <tr>
  ...
  <td width="392" colspan="2">
    <%
     int count=0;
	 int count1=0;
	 String str="select * from fn_accvoucher_contra";
 ...
 <tr>
  ...
  <td>
    <font size="2"><a href="fn_ledger_create.jsp"><font  size="2" color="#573801" face="verdana">Create Ledger</font></a>
    </font></td>
 </tr>
 <tr>
  <td align="right">
