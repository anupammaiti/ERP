...
public class _employeeinformationform1__jsp extends com.caucho.jsp.JavaPage
{
...
else if(session.getAttribute("user_name").toString().equals("admin") & "admin".equals(session.getAttribute("pwd").toString()) )
{
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("employeeinformationform1.jsp"), -3803092004994394337L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  }
