...
public class _account1_0admin__jsp extends com.caucho.jsp.JavaPage
{
...
if(session.getAttribute("user_name").toString().equals("admin") & "admin".equals(session.getAttribute("pwd").toString()) )
{
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("account1_admin.jsp"), -8930325815302131402L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  }
