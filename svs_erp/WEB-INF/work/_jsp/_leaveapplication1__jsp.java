...
public class _leaveapplication1__jsp extends com.caucho.jsp.JavaPage
{
...
else if(session.getAttribute("user_name").toString().equals("admin") & "admin".equals(session.getAttribute("pwd").toString()) )
{
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("leaveapplication1.jsp"), 6998735884380714297L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  }
