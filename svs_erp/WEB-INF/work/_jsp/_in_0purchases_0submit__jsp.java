...
public class _in_0purchases_0submit__jsp extends com.caucho.jsp.JavaPage
{
...
if(session.getAttribute("user_name").toString().equals("inventory") & "inventory".equals(session.getAttribute("pwd").toString()) )
{
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("in_purchases_submit.jsp"), -1637486502095737039L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  }
