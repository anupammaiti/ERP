...
public class _account_0operator__jsp extends com.caucho.jsp.JavaPage
{
...
if(session.getAttribute("user_name").toString().equals("fn_account") & "fn_account".equals(session.getAttribute("pwd").toString()) )
{
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("account_operator.jsp"), 248699558245963233L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  }
