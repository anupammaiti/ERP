...
<input align ="right" type="image" src="images/back.jpg"/>
 ...
 <table align="center"    >
   <tr>
     <td ><strong> <font  face = "verdana" size = "3" color="#573801" >Purchase Accounts Details</font></strong> </td>
   </tr>
 </table>
 <p>&nbsp;</p>
 ...
 <table align="center" width="1000" border="1"  bgcolor="#FADFC3" bordercolor="#F0B269">
	...
	<% 
		...
		String ps="select * from voucher_purchase";
		...
		i++;
	%>
	<form action="purchase_alter.jsp" >
	<tr>
	...
	String jps="select j.* from voucher_journal j ,ledgersdata l where j.to_parti=l.ledgername and l.under='SundryCreditors' ";
