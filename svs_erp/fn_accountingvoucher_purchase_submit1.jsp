...
<%
 String str2="insert into current_assets values(?,?,?)";
	...
	pstmt2.setString(3,session.getAttribute("amount").toString());
	pstmt2.executeUpdate();
 String str="insert into fn_accvoucher_purchase (refno, date1, partyaccname,salesledger,nameofitem,quantity,rate,units,amount,id) values(?,?,?,?,?,?,?,?,?,?)";
