...
<table align="center"    >
<tr>
 <td ><strong> <font color="#573801" size="3"  face = "verdana">Stock Group Selection</font></strong>
</td>
</tr>
</table>
...
<form action="stock_group_alt_display.jsp" method="post">
...
<% 
	Statement stmt=con.createStatement();
	 String s="select name from stockgroupdetails";
