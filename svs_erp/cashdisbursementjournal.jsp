...
<h4 align="center"><font color="#573801" face="verdana" size="3">Cash Disbursements Journal </font></h4>
<table align="center" border="1" bgcolor="#FADFC3" bordercolor="#F0B269">
  <form action="cashdisbursementjournalsubmit.jsp">
  <tr>
   <td>
   ...
   <td>
    <table align="center" border="1" bordercolor="#F0B269" bgcolor="#FADFC3" width="800">
	 ...
	 <tr>
	  ...
	  <td>
	   <input type="text" name="check1" size="6">
	  </td>
	  <td>
	   <input type="text" name="payee1" size="6">
	  </td>
	  <td>
	   ...
	   <td>
	    ...
	    <td><input type="text" name="amount1" size="6"></td>
	    <td><input type="text" name="amountp1" size="6"></td>
	 ...
	 <tr>
	  ...
	  <td>
	   <input type="text" name="check2" size="6">
	  </td>
	  <td>
	   <input type="text" name="payee2" size="6">
	  </td>
	  <td>
	  ...
	  <td>
	   <input type="text" name="check3" size="6">
	  </td>
	  <td>
	   <input type="text" name="payee3" size="6">
	  </td>
	  <td>
	 ...
	 <tr>
	  ...
	  <td>
	   <input type="text" name="check4" size="6">
	  </td>
	  <td>
	   <input type="text" name="payee4" size="6">
	  </td>
	  <td>
	 ...
	 <tr>
	  ...
	  <td>
	   <input type="text" name="check5" size="6">
	  </td>
	  <td>
	   <input type="text" name="payee5" size="6">
	  </td>
	  <td>
