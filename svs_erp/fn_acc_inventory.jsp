...
<input align ="left" type="image" src="images/back.jpg"/>
 ...
 <table align="center"    >
<tr>
 <td ><strong> <font  face = "verdana" size = "3"  color="#573801" >Invetntory Details</font></strong>
</td>
</tr>
...
<form action="fn_acc_in_purchases.jsp" method="post">
<tr>
<td >
<input type="submit"   name="voucher" value="         Purchases         " />
</td>
</tr>
</form>
...
<form action="fn_acc_in_pur_retrn.jsp" method="post">
<tr>
<td >
