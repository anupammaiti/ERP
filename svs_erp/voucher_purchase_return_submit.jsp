...
<p>&nbsp;</p>
 ...
 <%
	...
	String q1="insert into voucher_purchase (refno,v_date,vouchertype,partyaccname,purchaseledger,nameofitem,quantity,rate,units,amount,narration) values('"+s1+"','"+dt1+"','PurchaseReturns','"+s2+"','"+s3+"','"+s4+"',"+ii2+","+d1+",'"+s7+"',"+d22+",'"+s9+"')";
