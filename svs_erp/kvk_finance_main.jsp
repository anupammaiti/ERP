...
<title>SVS</title>
  ...
  function ff()
  {
  	var dec = confirm("Are You Sure, Want To Clear All The Data ? ");
	if(dec==true)
...
<input type="submit"  value="New project " onClick="ff();" />
...
<input align ="left" type="image" src="images/home.jpg"/>
 ...
 <table align="center"    >
<tr>
 <td ><strong> <font  face = "verdana"  size = "3"  color="#573801" >Masters  Details</font></strong>
</td>
</tr>
